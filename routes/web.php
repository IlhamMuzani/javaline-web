...
Route::middleware('driver')->prefix('driver')->group(function () {
    ...
    // Route::post('profile/update', [\App\Http\Controllers\Driver\ProfileController::class, 'update']);
});
...
Route::middleware('admin')->prefix('admin')->group(function () {
    ...
    Route::resource('rekanan_tarif', \App\Http\Controllers\Admin\TarifrekananController::class);
    ...
    Route::get('cetak_memotambahannominalfilter', [\App\Http\Controllers\Admin\InqueryMemotambahanController::class, 'cetak_memotambahannominalfilter']);
});