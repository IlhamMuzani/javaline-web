...
<section class="content">
    <div class="container-fluid">
        ...
        @endif
        <form action="{{ url('admin/faktur_pelunasan') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
            @csrf
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <label style="font-size:14px" class="form-label" for="kode_return">Kode invoice</label>
                    <div class="form-group d-flex">
                        <input class="form-control" hidden id="tagihan_ekspedisi_id" name="tagihan_ekspedisi_id" type="text" placeholder="" value="{{ old('tagihan_ekspedisi_id') }}" readonly style="margin-right: 10px; font-size:14px" />
                        <input class="form-control" id="kode_return" name="kode_return" type="text" placeholder="" value="{{ old('kode_return') }}" readonly style="margin-right: 10px; font-size:14px" />
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input style="font-size:14px" type="text" class="form-control" id="kode_pelanggan" readonly name="kode_pelanggan" placeholder="" value="{{ old('kode_pelanggan') }}">
                            </div>
                            <div class="form-group">
                                <label style="font-size:14px" for="nama_pelanggan">Nama Pelanggan</label>
                                <input style="font-size:14px" type="text" class="form-control" id="nama_pelanggan" readonly name="nama_pelanggan" placeholder="" value="{{ old('nama_pelanggan') }}">
                            </div>
                            <div class="form-group" hidden>
                                <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody id="tabel-potongan">
                    <tr id="potongan-0">
                        ...
                        <td hidden>
                            <div class="form-group">
                                <input type="text" class="form-control" id="nota_return_id-0" name="nota_return_id[]">
                            </div>
                        </td>
                        <td style="width:25%">
                            <div class="form-group">
                                <select class="select2bs4 select2-hidden-accessible" name="faktur_ekspedisi_id[]" data-placeholder="Pilih Faktur.." style="width: 100%;" data-select2-id="23" tabindex="-1" aria-hidden="true" id="faktur_ekspedisi_id-0">
                        ...
                        <td>
                            <div class="form-group">
                                <input onclick="potonganmemo(0)" style="font-size:14px" type="text" class="form-control" readonly id="kode_potongan-0" name="kode_potongan[]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input onclick="potonganmemo(0)" style="font-size:14px" type="text" class="form-control" readonly id="keterangan_potongan-0" name="keterangan_potongan[]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input onclick="potonganmemo(0)" style="font-size:14px" type="text" class="form-control" id="nominal_potongan-0" readonly name="nominal_potongan[]">
                            </div>
                        </td>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody id="tabel-pembelianlain">
                    <tr id="pembelianlain-0">
                        ...
                        <td hidden>
                            <div class="form-group">
                                <input type="text" class="form-control" id="potongan_penjualan_id-0" name="potongan_penjualan_id[]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input onclick="biayatambah(0)" style="font-size:14px" type="text" class="form-control" readonly id="kode_potonganlain-0" name="kode_potonganlain[]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input onclick="biayatambah(0)" style="font-size:14px" type="text" class="form-control" readonly id="keterangan_potonganlain-0" name="keterangan_potonganlain[]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input onclick="biayatambah(0)" style="font-size:14px" type="text" class="form-control" id="nominallain-0" readonly name="nominallain[]">
                            </div>
                        </td>
                        <td style="width: 100px">
                            <button style="margin-left:5px" type="button" class="btn btn-danger btn-sm" onclick="removeTambahan(0)">
                                <i class="fas fa-trash"></i>
                            </button>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select style="font-size: 14px" class="form-control" id="kategori" name="kategori">
                            ...
                            <option value="Bilyet Giro" {{ old('kategori') == 'Bilyet Giro' ? 'selected' : null }}>
                    ...
                    <div class="form-group">
                        ...
                        <input style="font-size: 14px" type="text" class="form-control" id="nomor" name="nomor" placeholder="masukkan no" value="{{ old('nomor') }}">
                    </div>
                    <div class="form-group">
                        <label style="font-size: 14px" for="tinggi">Tanggal</label>
                        <div class="input-group date" id="reservationdatetime">
                            <input style="font-size: 14px" type="date" id="tanggal" name="tanggal_transfer" placeholder="d M Y sampai d M Y" data-options='{"mode":"range","dateFormat":"d M Y","disableMobile":true}' value="{{ old('tanggal_transfer') }}" class="form-control datetimepicker-input" data-target="#reservationdatetime">
                        </div>
                    </div>
                    <div class="form-group">
                        <label style="font-size: 14px" for="tinggi">Nominal</label>
                        <input style="font-size: 14px" type="text" class="form-control" id="nominal" placeholder="masukkan nominal" name="nominal" value="{{ old('nominal') }}" oninput="formatRupiahsx(this)" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                    </div>
                </div>
                <div class="col-md-6" style="margin-left: 89px">
                    <div class="form-group">
                        <label style="font-size: 14px" for="totalpenjualan">Sub Total</label>
                        <input style="text-align: end; font-size: 14px" type="text" class="form-control" id="totalpembayaran" readonly name="totalpenjualan" placeholder="" value="{{ old('totalpenjualan') }}">
                    </div>
                    <div class="form-group">
                        <label style="font-size: 14px" for="tinggi">Ongkos Return</label>
                        <input style="text-align: end; font-size: 14px" type="text" class="form-control" id="ongkosBongkar" readonly name="dp" placeholder="" value="{{ old('dp') }}">
                    </div>
                    <div class="form-group">
                        <label style="font-size: 14px" for="tinggi">Potongan Lain-lain</label>
                        <input style="text-align: end; font-size: 14px" type="text" class="form-control" id="tambahan_pembayaran" readonly name="potonganselisih" placeholder="" value="{{ old('potonganselisih') }}">
                    </div>
                    <hr style="border: 2px solid black;">
                    <div class="form-group">
                        <label style="font-size: 14px" for="tinggi">Total Pembayaran</label>
                        <input style="text-align: end; font-size: 14px" type="text" class="form-control" id="totalPembayarans" readonly name="totalpembayaran" value="{{ old('totalpembayaran') }}" placeholder="">
                    </div>
                    <div class="form-group">
                        <label style="font-size: 14px" for="saldo_masuk">Pembayaran</label>
                        <input style="text-align: end; font-size: 14px" type="text" class="form-control" readonly id="saldo_masuk" name="saldo_masuk" placeholder="" value="{{ old('saldo_masuk') }}">
                    </div>
                    <div class="form-group">
                        <label style="font-size: 14px" for="tinggi">Selisih Pembayaran</label>
                        <input style="text-align: end; font-size: 14px" type="text" class="form-control" id="hasilselisih" readonly name="selisih" value="{{ old('selisih') }}" placeholder="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary btn-sm" onclick="GetReturn(
                                                '{{ $return->id }}',
                                                '{{ $return->kode_tagihan }}',
                                                '{{ $return->pelanggan_id }}',
                ...
                <div class="modal-body">
                    <table id="datatables6" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr onclick="getPotongan({{ $loop->index }})" data-id="{{ $potongan->id }}" data-kode_penjualan="{{ $potongan->kode_penjualan }}" data-tanggal_awal="{{ $potongan->tanggal_awal }}" data-grand_total="{{ $potongan->grand_total }}" data-param="{{ $loop->index }}">
                                <td class="text-center">{{ $loop->iteration }}</td>
                ...
                <div class="modal-body">
                    <table id="datatables66" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr onclick="getBiaya({{ $loop->index }})" data-id="{{ $potonganlain->id }}" data-kode_potongan="{{ $potonganlain->kode_potongan }}" data-keterangan="{{ $potonganlain->keterangan }}" data-grand_total="{{ $potonganlain->grand_total }}" data-param="{{ $loop->index }}">
                                <td class="text-center">{{ $loop->iteration }}</td>
...
<script>
    ...
    function attachInputEventListeners(index) {
        // Attach input event listener for both "kode_return" and "tanggal_return" fields
    ...
    function GetReturn(Return_id, KodeReturn, Pelanggan_id, KodePelanggan, NamaPell, Telpel, AlamatPelanggan,
        ...
        for (var i = 0; i < Fakturekspedisi_id.length; i++) {
            ...
            formHtml += '<tr>' +
                ...
                '<td>' +
                '   <div class="form-group">' +
                '       <input style="font-size:14px" readonly type="text" class="form-control total" name="total[]" value="' +
                totalFormatted + '">' +
                '   </div>' +
        ...
        formHtml += '<tr>' +
            ...
            '<td style="font-size:14px">' + grandTotalFormatted + '</td>' +
            '</tr>';
...
<script>
    ...
    function itemPembelian(urutan, key, style, value = null) {
        ...
        item_pembelian += '<div class="form-group">';
        item_pembelian += '<select class="form-control select2bs4" id="faktur_ekspedisi_id-' + key +
            '" name="faktur_ekspedisi_id[]">';
        item_pembelian += '<option value="">Pilih Faktur..</option>';
        item_pembelian += '@foreach ($fakturs as $faktur_ekspedisi_id)';
        item_pembelian +=
            '<option value="{{ $faktur_ekspedisi_id->id }}" {{ $faktur_ekspedisi_id->id == ' + faktur_ekspedisi_id + ' ? '
        selected ' : '
        ' }}>{{ $faktur_ekspedisi_id->kode_faktur }}</option>';
        ...
        $('#faktur_ekspedisi_id-' + key + '').val(faktur_ekspedisi_id).attr('selected', true);

    }

    function select2(id) {
        $(function() {
            $('#faktur_ekspedisi_id-' + id).select2({
                theme: 'bootstrap4'
            });
        });
    }
