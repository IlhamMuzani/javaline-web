...
@section('content')
                                            ...
                                            <td style="width:25%">
                                                <div class="form-group">
                                                    <select class="select2bs4 select2-hidden-accessible"
                                                        name="faktur_ekspedisi_id[]" data-placeholder="Pilih Faktur.."
                                                        style="width: 100%;" data-select2-id="23" tabindex="-1"
                                                        aria-hidden="true" id="faktur_ekspedisi_id-0">
    ...
    <script>
        ...
        function itemPembelian(urutan, key, style, value = null) {
            ...
            item_pembelian +=
                '<option value="{{ $faktur_ekspedisi_id->id }}" {{ $faktur_ekspedisi_id->id == ' + faktur_ekspedisi_id + ' ? 'selected' : '' }}>{{ $faktur_ekspedisi_id->kode_faktur }}</option>';
