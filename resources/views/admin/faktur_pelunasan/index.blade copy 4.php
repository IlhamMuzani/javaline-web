            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group d-flex">
                        <input class="form-control" hidden id="return_id" name="return_ekspedisi_id" type="text" placeholder="" value="{{ old('return_ekspedisi_id') }}" readonly style="margin-right: 10px; font-size:14px" />
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="font-size:14px" type="text" class="form-control" id="no_kabin" readonly name="no_kabin" placeholder="" value="{{ old('no_kabin') }}">
                                    </div>
                                    <div class="form-group">
                                        <label style="font-size:14px" for="no_pol">No. Mobil</label>
                                        <input style="font-size:14px" type="text" class="form-control" id="no_pol" readonly name="no_pol" placeholder="" value="{{ old('no_pol') }}">
                                    </div>
                                    <div class="form-group">
                                        <label style="font-size:14px" for="jenis_kendaraan">Jenis Kendaraan</label>
                                        <input style="font-size:14px" type="text" class="form-control" id="jenis_kendaraan" readonly name="jenis_kendaraan" placeholder="" value="{{ old('jenis_kendaraan') }}">
                                    </div>
                                    <div class="form-check" style="color:white">
                                        <label class="form-check-label">
                                            .
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="font-size:14px" type="text" class="form-control" id="kode_driver" readonly name="kode_driver" placeholder="" value="{{ old('kode_driver') }}">
                                    </div>
                                    <div class="form-group">
                                        <label style="font-size:14px" for="nama_driver">Nama Sopir</label>
                                        <input style="font-size:14px" type="text" class="form-control" id="nama_driver" readonly name="nama_driver" placeholder="" value="{{ old('nama_driver') }}">
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input style="font-size:14px; text-align:end" type="text" class="form-control" id="grand_total" readonly name="grand_total" placeholder="" value="{{ old('grand_total') }}">
                            </div>
                        </div>
...
<script>
    ...
    function GetReturn(Return_id, KodeReturn, Pelanggan_id, KodePelanggan, NamaPell, Telpel, AlamatPelanggan,
        Barang_id, KodeBarang, NamaBarang, Satuan, Jumlah) {
        ...
        for (var i = 0; i < barangIds.length; i++) {
            formHtml += '<tr>' +
                ...
                '<td hidden>' +
                '   <div class="form-group">' +
                '       <input type="text" class="form-control" name="faktur_ekspedisi_id[]" value="' + barangIds[i] +
                '" readonly>' +
                '   </div>' +
                '</td>' +
                '<td>' +
