                        ...
                        <div class="form-group" style="flex: 8;">
                            ...
                            <div id="form_pelanggan">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input style="font-size:14px" type="text" class="form-control"
                                            ...
                                            value="{{ old('kode_kendaraan', $inquery->kendaraan->kode_kendaraan ?? null) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea readonly type="text" class="form-control" id="alamat_muat" name="alamat_muat" placeholder="">{{ old('alamat_muat', $inquery->alamat_muat->alamat ?? null) }}</textarea>
                                </div>
                                <div hidden class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea readonly type="text" class="form-control" id="alamat_bongkar" name="alamat_bongkar" placeholder="">{{ old('alamat_bongkar', $inquery->alamat_bongkar->alamat ?? null) }}</textarea>
                                </div>
                            </div>
                        </div>
