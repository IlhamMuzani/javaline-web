...
@section('title', 'Pilih Laporan Memo Ekspedisi')
...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Pilih Laporan Memo Ekspedisi</h4>
                        ...
                        <form id="memoForm" enctype="multipart/form-data" autocomplete="off" method="post">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Pilih Laporan Memo Ekspedisi</h3>
                                </div>
                                <div class="card-body">
    ...
    <script>
        document.getElementById('lanjutkanBtn').addEventListener('click', function() {
            ...
            switch (memoType) {
                case 'perjalanan':
                    window.location.href = "{{ url('admin/laporan_memoekspedisi') }}";
                    break;
                case 'borong':
                    window.location.href = "{{ url('admin/laporan_memoborong') }}";
                    break;
                     case 'tambahan':
                    window.location.href = "{{ url('admin/laporan_memotambahan') }}";
                    break;
                default:
