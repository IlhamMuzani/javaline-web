                            ...
                            <tbody>
                                @foreach ($inquery as $pembelian)
                                    <tr class="dropdown"{{ $pembelian->id }}>
                                        ...
                                        <td>{{ $pembelian->kode_pembelianaki }}</td>
                                        ...
                                        <td>{{ number_format($pembelian->grand_total, 2, ',', '.') }}</td>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery-pembelianaki/unpostpembelianaki/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery-pembelianaki/postingpembelianaki/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
