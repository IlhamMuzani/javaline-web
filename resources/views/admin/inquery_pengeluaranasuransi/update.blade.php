...
@section('title', 'Inquery Pengambilan Uang Asuransi')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Pengambilan Uang Asuransi Barang</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_pengeluaranasuransi') }}">Inquery
                                Pelunasan</a>
                        </li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery_pengeluaranasuransi/' . $inquery->id) }}" method="POST" autocomplete="off">
                @method('put')
                @csrf <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pengambilan Uang Asuransi Barang</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="sisa_asuransi">Sisa Saldo Uang Asuransi Barang</label>
                                    <input style="text-align: end;margin:right:10px" type="text" class="form-control"
                                        id="sisa_asuransi" readonly name="sisa_asuransi"
                                        value="{{ old('sisa_asuransi', $inquery->sisa_asuransi) }}" placeholder="" placeholder="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="saldo_masuk">Saldo Keluar</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; margin:right:10px" type="text" class="form-control"
                                        ...
                                        value="{{ old('grand_total', number_format($inquery->grand_total, 2, ',', '.')) }}">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            // Mengambil nilai sisa saldo dari elemen dengan id sisa_asuransi
            var sisaSaldoValue = $('#sisa_asuransi').val();

            // Mengonversi nilai ke format rupiah
            var sisaSaldoRupiah = formatRupiahx(sisaSaldoValue);

            // Menetapkan nilai ke input sisa saldo
            $('#sisa_asuransi').val(sisaSaldoRupiah);
        ...
        function updateSubTotal() {
            ...
            var sisaSaldo = parseCurrency($('#sisa_asuransi').val());
