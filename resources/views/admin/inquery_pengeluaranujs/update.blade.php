...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_pengeluaranujs') }}">Inquery Pelunasan</a>
                        </li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery_pengeluaranujs/' . $inquery->id) }}" method="POST" autocomplete="off">
                @method('put')
                @csrf <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pengambilan UJS</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
