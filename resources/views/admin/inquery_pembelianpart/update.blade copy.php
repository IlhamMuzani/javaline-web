                            ...
                            <tr id="pembelian-{{ $loop->index }}">
                                ...
                                <td>
                                    <div class="form-group" hidden>
                                        <input type="text" class="form-control" id="nomor_seri-0" name="detail_ids[]"
                                            value="{{ $detail['id'] }}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="text" readonly class="form-control" id="satuan-0" name="satuan[]"
                                            value="{{ $detail['satuan'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="number" class="form-control hargasatuan" id="hargasatuan-0"
                                            name="hargasatuan[]" data-row-id="0" value="{{ $detail['hargasatuan'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="text-align: center;">
                        <form action="{{ url('admin/tambah_sparepartin') }}" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            <div class="card">
                                <div class="card-header">
