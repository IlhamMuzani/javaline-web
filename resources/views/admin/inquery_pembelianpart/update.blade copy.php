...
@section('title', 'Perbarui Pembelian Part')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Perbarui Pembelian part</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="tabel-pesanan">
                            ...
                            <tr id="pesanan-{{ $index }}">
                                <td class="text-center" id="urutan">{{ $index + 1 }}</td>
                                <td style="width: 240px; align-items: center;">
                                    ...
                                    <div class="d-flex"
                                        ...
                                        <div class="form-group mr-2" style="flex: 8;">
                                            <select class="select2bs4 select2-hidden-accessible" name="sparepart_id[]"
                                                data-placeholder="Cari Kode.." style="width: 100%;">
                                                <option value="">- Pilih -</option>
                                                @foreach ($spareparts as $sparepart)
                                                <option value="{{ $sparepart->id }}"
                                                    {{ old('pembelian_part_id', $detail['pembelian_part_id']) ? 'selected' : '' }}>
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="nama_barang-0"
                                            value="{{ $detail['nama_barang'] }}" name="nama_barang[]"
                                            onkeyup="getTotal(0)">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="number" class="form-control" id="jumlah-0"
                                            value="{{ $detail['jumlah'] }}" name="jumlah[]" onkeyup="getTotal(0)">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="harga-0"
                                            value="{{ $detail['harga'] }}" name="harga[]">
                                    </div>
                                </td>
                                <td>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama_barang" name="nama_barang"
                                            placeholder="Masukan nama pemilik" value="">
                                    </div>
                                    <div class="form-group">
