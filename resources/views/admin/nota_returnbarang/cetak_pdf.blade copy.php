...
<body style="margin: 0; padding: 0;">
    ...
    <table cellpadding="2" cellspacing="0">
        <tr>
            <td class="text-align: left" style="font-size: 12px; display: block;">Nama Pelanggan</td>
            <td style="text-align: left; font-size: 12px;">
                <span class="content2">
                    : <span>{{ $cetakpdf->nama_pelanggan }}</span></span>
                <br>
            </td>
        ...
        <tr>
            <td class="text-align: left" style="font-size: 12px; display: block;">Alamat</td>
            <td style="text-align: left; font-size: 12px;">
                <span class="content2">
                    :
                    <span>{{ $cetakpdf->alamat_pelanggan }}</span></span>
                <br>
            </td>
            <td class="info-text-align: left" style="font-size: 12px; margin-left: 5px; display: block;">Kode Sopir
            </td>
            <td style="text-align: left; font-size: 12px;">
                <span class="content2">
        ...
        <tr>
            <td class="text-align: left" style="font-size: 12px; display: block;">Telp</td>
            <td style="text-align: left; font-size: 12px;">
                <span class="content2">
            ...
            <td class="text-align: left" style="font-size: 12px; margin-left: 5px; display: block;">Nama Sopir
            </td>
            <td style="text-align: left; font-size: 12px;">
                <span class="content2">
        ...
        <tr>
            <td class="text-align: left" style="font-size: 12px; display: block;">Id Pelanggan</td>
            <td style="text-align: left; font-size: 12px;">
                <span class="content2">
            ...
            <td class="text-align: left" style="font-size: 12px; margin-left: 5px; display: block;">Telp
            </td>
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: left;  font-size: 15px;">Kode Barang</td>
            <td class="td" style="text-align: left;  font-size: 15px;">Nama Barang</td>
    ...
    {{-- <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            <td colspan="4" style="text-align: right; padding-left: 78px; font-size: 15px;">Potongan
            </td>
            <td class="td" style="text-align: right; font-size: 15px;">
                0
            </td>
        ...
        <tr>
            <td colspan="4" style="text-align: right; padding: 0px; font-size: 15px;">Grand Total</td>
            <td class="td" style="text-align: right;  font-size: 15px;">
                {{ number_format($totalHarga, 0, ',', '.') }}
    </td>
    </tr>
