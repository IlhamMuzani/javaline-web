                    ...
                    <div id="formmemotambahans" class="form-group" style="flex: 8;">
                        ...
                        <div class="form-group" hidden>
                            ...
                            <input type="text" class="form-control" id="memo_id" name="memo_id"
                                value="{{ old('memo_id') }}" readonly placeholder="" value="">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group d-flex">
                                    <input class="form-control" id="nama_driver" name="nama_driver" type="text"
                                        placeholder="" value="{{ old('nama_driver') }}" readonly
                                        style="margin-right: 10px;font-size:14px" />
                                    <button class="btn btn-primary" type="button"
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-size:14px" type="text" class="form-control" id="saldo_deposit"
                                        readonly name="saldo_deposit" placeholder="" value="{{ old('saldo_deposit') }}">
                                </div>
                                <div class="form-check" style="color:white">
                                    <label class="form-check-label">
                                        .
                            ...
                            <tbody id="tabel-rute">
                                <tr id="rute-0">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control" readonly
                                                id="kode_rutes" name="kode_rutes" value="{{ old('kode_rutes') }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control" readonly
                                                id="nama_rutes" name="nama_rutes" value="{{ old('nama_rutes') }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="number" class="form-control harga_rute"
                                                readonly id="harga_rute" value="{{ old('harga_rute') }}"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control totalrute"
                                                readonly id="totalrute" name="totalrute" value="{{ old('totalrute') }}">
                                        </div>
                                    </td>
                                    <td style="width: 50px">
                                    ...
                                    <td>
                                        <div class="form-group" style="display: flex; align-items: center;">
                                            ...
                                            <input style="width: 300px; font-size: 14px;" type="text"
                                                ...
                                                name="uangjalans" placeholder="" value="{{ old('uangjalans') }}">
                                        ...
                                        <div class="form-group" style="display: flex; align-items: center;">
                                            ...
                                            <input style="width: 300px; font-size: 14px; margin-left:6px" type="text"
                                                ...
                                                value="{{ old('deposit_driver') }}" placeholder=""
                                                oninput="limitInput()">
                                        </div>
                                        <div class="form-group" style="display: flex; align-items: center;">
                                            ...
                                            <input style="width: 300px; font-size: 14px;" type="text"
                                                ...
                                                name="potongan_memo" placeholder="" value="{{ old('potongan_memo') }}">
                                            <input style="margin-left: 565px" class="form-check-input" type="checkbox"
                                                id="additional_checkbox" name="additional_checkbox"
                                                onchange="limitInput()">
                                        ...
                                        <div class="form-group" style="display: flex; align-items: center;">
                                            ...
                                            <input style="width: 300px; font-size: 14px;" id="uang_jaminan" type="text"
                                                class="form-control text-right" readonly name="uang_jaminan"
                                                placeholder="" value="{{ old('uang_jaminan') }}">
                                ...
                                <td>
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        ...
                                        <input style="width: 300px; font-size: 14px;" type="text"
                                            ...
                                            name="total_borongs" placeholder="" value="{{ old('total_borongs') }}">
                                    ...
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        <label style="font-size: 14px; margin-right: 31px;"
                                            for="rute_perjalanan">Administrasi</label>
                                        ...
                                        <label style="font-size: 14px; margin-right: 20px; margin-left:46px"
                                            for="rute_perjalanan">Administrasi</label>
                                        <input style="width: 300px; font-size: 14px;" type="text" class="form-control"
                                    ...
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        <label style="font-size: 14px; margin-right: 25px;"
                                            ...
                                            Sopir</label>
                                        <input style="width: 300px; font-size: 14px;" type="text"
                                            class="form-control text-right" id="depositsopir2" readonly
                                            name="depositsopir2" placeholder="" value="{{ old('depositsopir2') }}">
                                        <label style="font-size: 14px; margin-right: 10px; margin-left:45px"
                                            for="rute_perjalanan">Deposit Sopir</label>
                                        <input style="width: 300px; font-size: 14px; margin-left: 6px" type="text"
                                            class="form-control" id="depositsopir" name="depositsopir" placeholder=""
                                            value="{{ old('depositsopir') }}" oninput="limitInputs()">
                                    </div>
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        <label hidden style="font-size: 14px; margin-right: 78px;"
                                            for="rute_perjalanan">Total</label>
                                        <input hidden style="width: 300px; font-size: 14px;" type="text"
                                            class="form-control text-right" id="hasilsss" readonly name="totals"
                                            placeholder="" value="{{ old('totals') }}" onclick="calculateHasilsrute()">
                                        <input style="margin-left: 555px" class="form-check-input" type="checkbox"
                                            id="additional_checkboxs" name="additional_checkboxs"
                                            onchange="limitInputs()">
                                        <label style="margin-left: 590px" class="form-check-label"
                                            for="additional_checkbox">
                                            Min Deposit 50.000
                                        </label>
                                        <label
                                            style="color:white; font-size: 14px; margin-right: 78px; margin-left: 275px"
                                            for="rute_perjalanan">.</label>
                                    </div>
                                </td>
                            </tr>
                ...
                <td>
                    <div class="form-group">
                        <input style="font-size:14px; font-weight:bold" readonly type="text" class="form-control"
                            id="sub_total" name="sub_total" value="{{ old('sub_total') }}" onclick="SubTotalss()">
                    </div>
                </td>
                </tr>
                </tbody>
