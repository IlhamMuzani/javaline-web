                ...
                <div class="card-body">
                    ...
                    <div id="formmemotambahans" class="form-group" style="flex: 8;">
                        ...
                        <div class="form-group" hidden>
                            ...
                            <input type="text" class="form-control" id="memo_id" name="memo_id" value="{{ old('memo_id') }}" readonly placeholder="" value="">
                        </div>
                        <div class="form-group">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="tabel-pembelian">
                            <tr id="pembelian-0">
                                ...
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly id="kode_biaya" name="kode_biaya[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly id="nama_biaya" name="nama_biaya[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" id="nominal" readonly name="nominal[]">
                                    </div>
                                </td>
                                <td style="width: 50px">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="tabel-potongan">
                            <tr id="potongan-0">
                                ...
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly id="kode_potongan" name="kode_potongan[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly id="keteranganpotongan" name="keterangan_potongan[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" id="nominalpotongan" readonly name="nominal_potongan[]">
                                    </div>
                                </td>
                                <td style="width: 50px">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="tabel-rute">
                            <tr id="rute-0">
                                ...
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly id="kode_rutes" name="kode_rutes[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly id="nama_rutes" name="nama_rutes[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="number" class="form-control harga_rute" readonly id="harga_rute" name="harga_rute[]" data-row-id="0">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="number" class="form-control jumlah" id="jumlah" name="jumlah[]" data-row-id="0">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                ...
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control totalrute" readonly id="totalrute" name="totalrute[]">
                                    </div>
                                </td>
                                <td style="width: 50px">
                                ...
                                <td>
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        <label style="font-size: 14px; margin-right: 50px;" for="uangjalan">Uang
                                            Jalan</label>
                                        <input style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="uangjalans" readonly name="uangjalans" placeholder="" value="{{ old('uangjalans') }}">
                                    ...
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        <label style="font-size: 14px; margin-right: 18px;" for="rute_perjalanan">Biaya
                                            Tambahan</label>
                                        <input style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="harga_tambahan" readonly name="biaya_tambahan" value="{{ old('biaya_tambahan') }}">
                                    ...
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        ...
                                        <input style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="potongan_memo" readonly name="potongan_memo" placeholder="" value="{{ old('potongan_memo') }}">
                                    ...
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        ...
                                        <input style="width: 300px; font-size: 14px;" id="uang_jaminan" type="text" class="form-control text-right" readonly name="uang_jaminan" placeholder="" value="{{ old('uang_jaminan') }}">

                                    </div>
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        <label style="font-size: 14px; margin-right: 37px;" for="rute_perjalanan">Deposit
                                            Sopir</label>
                                        <input style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="depositsdriverss" readonly name="deposit_drivers" placeholder="" value="{{ old('deposit_drivers') }}">
                            ...
                            <td>
                                <div class="form-group" style="display: flex; align-items: center;">
                                    <label style="font-size: 14px; margin-right: 30px;" for="rute_perjalanan">Total
                                        Borong</label>
                                    <input style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="totalborong" readonly name="total_borongs" placeholder="" value="{{ old('total_borongs') }}">
                                ...
                                <div class="form-group" style="display: flex; align-items: center;">
                                    ...
                                    <input style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="pph2" readonly name="pphs" placeholder="" value="{{ old('pphs') }}">
                                ...
                                <div class="form-group" style="display: flex; align-items: center;">
                                    <label style="font-size: 14px; margin-right: 31px;" for="rute_perjalanan">Administrasi</label>
                                    <input style="width: 300px; font-size: 14px;" id="uangjaminanss" type="text" class="form-control text-right" readonly name="uang_jaminans" placeholder="" value="{{ old('uang_jaminans') }}">
                                    <label style="font-size: 14px; margin-right: 20px; margin-left:46px" for="rute_perjalanan">Administrasi</label>
                                    <input style="width: 300px; font-size: 14px;" type="text" class="form-control" readonly placeholder="" value="1 %">
                                </div>
                                <div class="form-group" style="display: flex; align-items: center;">
                                    <label style="font-size: 14px; margin-right: 25px;" for="rute_perjalanan">Deposit
                                        Sopir</label>
                                    <input style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="depositsopir2" readonly name="depositsopir2" placeholder="" value="{{ old('depositsopir2') }}">
                                    <label style="font-size: 14px; margin-right: 10px; margin-left:45px" for="rute_perjalanan">Deposit Sopir</label>
                                    <input style="width: 300px; font-size: 14px; margin-left: 6px" type="text" class="form-control" id="depositsopir" name="depositsopir" placeholder="" value="{{ old('depositsopir') }}" oninput="limitInputs()">
                                </div>
                                <div class="form-group" style="display: flex; align-items: center;">
                                    <label hidden style="font-size: 14px; margin-right: 78px;" for="rute_perjalanan">Total</label>
                                    <input hidden style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="hasilsss" readonly name="totals" placeholder="" value="{{ old('totals') }}" onclick="calculateHasilsrute()">
                                    <input style="margin-left: 555px" class="form-check-input" type="checkbox" id="additional_checkboxs" name="additional_checkboxs" onchange="limitInputs()">
                                    <label style="margin-left: 590px" class="form-check-label" for="additional_checkbox">
                                        Min Deposit 50.000
                                    </label>
                                    <label style="color:white; font-size: 14px; margin-right: 78px; margin-left: 275px" for="rute_perjalanan">.</label>
                                </div>
                            </td>
                        </tr>
                    </tbody>
