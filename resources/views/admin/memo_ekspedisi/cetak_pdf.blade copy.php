...
<body style="margin: 0; padding: 0;">
    ...
    <div style="text-align: center;">
        <span style="font-weight: bold; font-size: 24px;">PT JAVA LINE LOGISTICS</span>
        <br>
    ...
    @if ($cetakpdf->kategori == 'Memo Perjalanan')
        ...
        <table style="width: 100%;" cellpadding="2" cellspacing="0">
            <tr>
                <td class="td"
                    style="text-align: left; padding-right: 330px; font-size: 14px; white-space: normal; width: 60%;">
                    {{ $cetakpdf->keterangan }}
                </td>
            </tr>
        </table>
    ...
    @if (!($cetakpdf->kategori == 'Memo Perjalanan' || $cetakpdf->kategori == 'Memo Borong'))
        ...
        <table style="width: 100%;" cellpadding="2" cellspacing="0">
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 0px; font-size: 14px;">Qty</td>
