...
@section('title', 'Laporan Pemasangan Aki')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Pemasangan Aki</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Pemasangan Aki</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Laporan Pemasangan Aki</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($inquery as $pemasangan_part)
                                    <tr>
                                        ...
                                        <td>{{ $pemasangan_part->kode_pemasanganaki }}</td>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/laporan-pemasanganaki') }}";
            form.submit();
        }
        ...
        function printReport() {
            ...
            if (startDate && endDate) {
                form.action = "{{ url('admin/print-pemasanganaki') }}" + "?start_date=" + startDate + "&end_date=" +
                    endDate;
                form.submit();
            } else {
