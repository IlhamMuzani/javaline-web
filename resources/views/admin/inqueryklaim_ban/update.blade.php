...
@section('title', 'Inquery Klaim Ban')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_fakturekspedisi') }}">Inquery Klaim Ban</a>
                        </li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inqueryklaim_ban/' . $inquery->id) }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Inquery Klaim Ban</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly id="km_pemasangan1" name="km_pemasangan"
                                placeholder="Masukan km pemasangan" value="{{ $inquery->ban->km_pemasangan }}">
                        </div>
                        <div class="form-group">
                            <label for="km_pelepasan1">Km Pelepasan</label>
                            <input type="text" class="form-control" id="km_pelepasan1" name="km_pelepasan"
                                placeholder="Masukan km pelepasan" value="{{ $inquery->ban->km_pelepasan }}">
                        </div>
                        <div class="form-group" hidden>
                            <label for="km_pelepasan1">keterangan</label>
                            <input type="text" class="form-control" name="keterangan" placeholder="Masukan"
                                value="{{ $inquery->ban->keterangan }}">
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input style="text-align: end;margin:right:10px" type="text"
                                                    ...
                                                    value="{{ number_format($inquery->karyawan->tabungan, 0, ',', '.') }}"
                                                    placeholder="">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input readonly type="text" class="form-control" id="nama_lengkap"
                                                    ...
                                                    value="{{ $inquery->karyawan->nama_lengkap }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" id="keterangans" name="keterangans" placeholder="Masukan keterangan">{{ $inquery->keterangan }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
