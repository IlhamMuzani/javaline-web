                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="kategori" name="kategori">
                            ...
                            <option value="Golongan 1"
                                {{ old('kategori', $rute_perjalanan->kategori) == 'Golongan 1' ? 'selected' : null }}>
                                GOLONGAN 1</option>
                            <option value="Golongan 2"
                                {{ old('kategori', $rute_perjalanan->kategori) == 'Golongan 2' ? 'selected' : null }}>
                                GOLONGAN 2</option>
                            <option value="Golongan 3"
                                {{ old('kategori', $rute_perjalanan->kategori) == 'Golongan 3' ? 'selected' : null }}>
                                GOLONGAN 3</option>
                            <option value="Golongan 4"
                                {{ old('kategori'), $rute_perjalanan->kategori == 'Golongan 4' ? 'selected' : null }}>
                                GOLONGAN 4</option>
                            <option value="Golongan 5"
                                {{ old('kategori', $rute_perjalanan->kategori) == 'Golongan 5' ? 'selected' : null }}>
                                GOLONGAN 5</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="harga">Biaya</label>
                        <input type="number" class="form-control" id="harga" name="harga" placeholder="masukkan biaya"
                            value="{{ old('harga', $rute_perjalanan->harga) }}">
                    </div>
                </div>
