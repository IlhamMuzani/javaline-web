...
<body style="margin: 0; padding: 0;">
    ...
    <table cellpadding="2" cellspacing="0">
        <tr>
            <td class="text-align: left" style="font-size: 17px; display: block;">Nama Pelanggan</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
                    :{{ $cetakpdf->nama_pelanggan }} </span>
                <br>
            </td>
            <td class="text-align: left" style="font-size: 17px; margin-left: 40px; display: block;">No Mobil</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
        ...
        <tr>
            <td style="font-size: 17px; display: block;">Alamat</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
            ...
            <td style="font-size: 17px; margin-left: 40px; display: block;">Kode Sopir</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
        ...
        <tr>
            <td style="font-size: 17px; display: block;">Telp / Hp</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
            ...
            <td style="font-size: 17px; margin-left: 40px; display: block;">Nama Sopir</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
        ...
        <tr>
            <td style="font-size: 17px; display: block;">ID Pelanggan</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 5px; font-size: 17px;">Nama Barang</td>
            <td class="td" style="text-align: center; padding: 5px; font-size: 17px;">Satuan</td>
            <td class="td" style="text-align: center; padding: 5px; font-size: 17px;">Qty</td>
        </tr>
        ...
        @foreach ($details as $item)
            <tr>
                ...
                <td class="info-text info-left" style="font-size: 17px; text-align: center;">
                    {{ $item->nama_barang }}
                </td>
                <td class="info-text info-left" style="font-size: 17px; text-align: center;">
                    {{ $item->satuan }}
...
<div class="container">
    {{-- <a href="{{ url('admin/inquery_returnekspedisi') }}" class="blue-button">Kembali</a> --}}
    <a href="{{ url('admin/inquery_returnekspedisi') . '?status=&tanggal_awal=' . $cetakpdf->tanggal_awal . '&tanggal_akhir=' . $cetakpdf->tanggal_awal . '&ids=' }}"
        class="blue-button">
        Kembali
    </a>
    <a href="{{ url('admin/return_ekspedisi/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
