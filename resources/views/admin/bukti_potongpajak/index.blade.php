                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div style="text-align: left;">
                                                        <form
                                                            action="{{ url('admin/updatebuktitagihan/' . $faktur->id) }}"
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="gambar_bukti">Dokumen bukti
                                                                        <small>(Kosongkan
                                                                            saja
                                                                            jika
                                                                            tidak
                                                                ...
                                                                @foreach ($faktur->detail_tagihan as $item)
                                                                    <div class="form-group mb-3">
                                                                        @if ($item->gambar_buktifaktur == null)
                                                                            <p class="mt-3">Tidak ada PDF yang diunggah.
                                                                            </p>
                                                                        @else
                                                                            <p class="mt-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="gambar">Dokumen bukti
                                                                            <small>(Kosongkan saja
                                                                                jika tidak ingin
