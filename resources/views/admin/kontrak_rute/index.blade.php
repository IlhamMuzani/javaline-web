                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($kontrak_rute->status == 'unpost')
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/inquery_kontrakkerja/' . $kontrak_rute->id . '/edit') }}">Update</a>
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/kontrak_rute/' . $kontrak_rute->id) }}">Show</a>
                                                <form style="margin-top:5px" method="GET"
                                                    action="{{ route('hapussewa', ['id' => $kontrak_rute->id]) }}">
                                                    <button type="submit"
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_kontrakkerja/unpostsewakendaraan/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_kontrakkerja/postingsewakendaraan/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
