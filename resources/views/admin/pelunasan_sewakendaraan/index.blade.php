...
@section('title', 'Faktur Pelunasan Sewa Kendaraan')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Faktur Pelunasan Sewa Kendaraan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Faktur Pelunasan Sewa Kendaraan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Faktur Pelunasan Sewa Kendaraan</h3>
                    <div class="float-right">
                        <a href="{{ url('admin/pelunasan_sewakendaraan/create') }}" class="btn btn-primary btn-sm">
