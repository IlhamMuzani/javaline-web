...
@section('title', 'Faktur Pelunasan Per Faktur')
...
@section('content')
    ...
    <div class="content-header">
        <div class="containers-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Faktur Pelunasan Per Faktur</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/pelunasan_sewakendaraan') }}">Faktur Pelunasan</a></li>
    ...
    <section class="content">
        <div class="containers-fluid">
            ...
            @endif
            <form action="{{ url('admin/pelunasan_sewakendaraan') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Faktur Pelunasan Per Faktur</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label style="font-size:14px" class="form-label" for="kode_vendor">Kode
                                        Rekanan</label>
                                    <div class="form-group d-flex">
                                        <input class="form-control" id="kode_vendor" name="kode_vendor" type="text"
                                            placeholder="" value="{{ old('kode_vendor') }}" readonly
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody id="tabel-faktur">
                                        <tr id="faktur-0">
                                            ...
                                            <td hidden>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="sewa_kendaraan_id-0"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Data Faktur Sewa Kendaraan</h4>
    ...
    <script>
        ...
        function itemPembelianfak(urutan, key, value = null) {
            ...
            item_pembelian += '<td hidden>';
            item_pembelian += '<div class="form-group">'
            item_pembelian += '<input type="text" class="form-control" id="sewa_kendaraan_id-' + urutan +
            ...
            $('#kategori').on('change', function() {
                ...
                switch (selectedValue) {
                    case 'pelunasan1':
                        ...
                        //     break;
                    case 'pelunasan3':
                        window.location.href = "{{ url('admin/pelunasan_sewakendaraan') }}";
                        break;
                    default:
