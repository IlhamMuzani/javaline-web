...
<head>
    ...
    <title>Faktur Pelunasan Sewa Kendaraan</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    <table cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="info-catatan2" style="font-size: 13px; margin-left: 40px; display: block;">Nama Rekanan</td>
            <td style="text-align: left; font-size: 13px;">
                <span class="content2">
                    {{ $cetakpdf->nama_vendor }}
                </span>
                <br>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="info-catatan2" style="font-size: 13px; margin-left: 40px; display: block;">ID Rekanan</td>

            <td style="text-align: left; font-size: 13px;">
                <span class="content2">
                    {{ $cetakpdf->kode_vendor }}
                </span>
                <br>
            </td>
        </tr>
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 20px;">FAKTUR PELUNASAN SEWA KENDARAAN</span>
        <br>
    </div>
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 5px; font-size: 13px;">F. Sewa Kendaraan</td>
            <td class="td" style="text-align: right; padding: 5px; font-size: 13px;">Total Sewa Kendaraan</td>
        ...
        @foreach ($details as $item)
            @php
                $total_dengan_potongan = $item->total;
            @endphp
            ...
            <td style="text-align: center;">
                <table style="margin: 0 auto;">
                    <tr style="text-align: center;">
                        <td class="label">{{ $cetakpdf->nama_vendor }}</td>
                    </tr>
                    <tr>
...
<div class="container">
    <a href="{{ url('admin/pelunasan_sewakendaraan') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/pelunasan_sewakendaraan/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
