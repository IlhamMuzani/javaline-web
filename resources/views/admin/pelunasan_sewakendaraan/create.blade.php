...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/pelunasan_sewakeninvoice') }}">Faktur Pelunasan</a></li>
    ...
    <section class="content">
        <div class="containers-fluid">
            ...
            @endif
            <form action="{{ url('admin/pelunasan_sewakeninvoice') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group d-flex">
                            <input class="form-control" hidden id="invoice_sewakendaraan_id" name="invoice_sewakendaraan_id"
                                type="text" placeholder="" value="{{ old('invoice_sewakendaraan_id') }}" readonly
                            ...
                            <button class="btn btn-primary" type="button" onclick="showCategoryModalVendor(this.value)">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-size:14px" type="text" class="form-control" id="nama_vendor"
                                        readonly name="nama_vendor" placeholder="" value="{{ old('nama_vendor') }}">
                                </div>
                                <div class="form-group" hidden>
                                    <div class="form-group">
    ...
    <script>
        ...
        function loadFormDataFromSessionStorage() {
            ...
            var returnId = $('#invoice_sewakendaraan_id').val(); // Get the value of return_id
        ...
        function GetReturn(Return_id, KodeReturn, Pelanggan_id, KodePelanggan, NamaPell, Telpel, AlamatPelanggan,
            ...
            document.getElementById('invoice_sewakendaraan_id').value = Return_id;
            ...
            document.getElementById('alamat_vendor').value = AlamatPelanggan;
            ...
            for (var i = 0; i < Fakturekspedisi_id.length; i++) {
                ...
                formHtml += '<tr>' +
                    ...
                    '<td hidden>' +
                    '   <div class="form-group">' +
                    '       <input type="text" class="form-control" name="sewa_kendaraan_id[]" value="' +
        ...
        $(document).ready(function() {
            ...
            $('#kategori').on('change', function() {
                ...
                switch (selectedValue) {
                    case 'pelunasan1':
                        window.location.href = "{{ url('admin/pelunasan_sewakenfaktur/create') }}";
                        break;
                        // case 'pelunasan2':
                        //     window.location.href = "{{ url('admin/faktur_pelunasanperinvoice') }}";
                        //     break;
                    case 'pelunasan3':
                        window.location.href = "{{ url('admin/pelunasan_sewakeninvoice/create') }}";
                        break;
                    default:
