...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                                    ...
                                    <td class="text-center">
                                        @if ($kendaraan->status_perjalanan == 'Tunggu Muat')
                                            <button type="button" class="btn btn-yellow btn-sm"
                                                style="background-color: #ffcc00;" data-toggle="modal"
                                        ...
                                        @if ($kendaraan->status_perjalanan == 'Tunggu Bongkar')
                                            <button type="button" class="btn btn-yellow btn-sm"
                                                style="background-color: #ffee00;" data-toggle="modal"
                                                data-target="#modal-posting-{{ $kendaraan->id }}">
                                                <i class="fas fa-check"></i>
                                            </button>
                                        @endif
                                                    ...
                                                    <form action="{{ url('admin/status_perjalanan/' . $kendaraan->id) }}"
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-label" for="status_perjalanan">Status
                                                                    Perjalanan</label>
                ...
                {{-- <div class="modal fade" id="modal-konfirmasiselesai-{{ $kendaraan->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <p>Kendaraan dengan nomor kabin
                                                    <strong>{{ $kendaraan->no_kabin }}</strong> Telah selesai mengantar ?
                                                </p>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-primary"
                                                    href="{{ route('konfirmasiselesai', ['id' => $kendaraan->id]) }}">Selesai</a>
                                            </div>
                                        </div>
                                    </div>
                                </div> --}}
    ...
    <script>
        ...
        function getData(id) {
            var user_id = document.getElementById('user_id' + id);
            $.ajax({
                url: "{{ url('admin/status_perjalanan/driver') }}" + "/" + user_id.value,
                type: "GET",
                dataType: "json",
                success: function(user_id) {

                    var nama_lengkap = document.getElementById('nama_lengkap' + id);
                    nama_lengkap.value = user_id.karyawan.nama_lengkap;
