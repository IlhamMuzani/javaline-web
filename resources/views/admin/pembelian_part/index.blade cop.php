        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('admin/pembelian_') }}">Transaksi</a></li>
    ...
    <div class="modal fade" id="modal-part">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="text-align: center;">
                        <form action="{{ url('admin/tambah_sparepart') }}" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="jumlah" name="jumlah"
                                            placeholder="Tersedia" value="{{ old('jumlah') }}">
                                    </div>
                                    <div class="form-group">
    ...
    <div class="modal fade" id="tableKategori" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <button type="button" data-toggle="modal" data-target="#modal-part" class="btn btn-primary btn-sm"
                        data-dismiss="modal">
                        Tambah
                    </button>
...
function itemPembelian(urutan, key, value = null) {
    ...
    item_pembelian += '<td>';
    item_pembelian += '<div class="form-group">'
    item_pembelian += '<input type="text" class="form-control" id="kode_partdetail-' + key +
    ...
    item_pembelian += '<td>';
    item_pembelian += '<div class="form-group">'
    item_pembelian += '<input type="text" class="form-control" id="satuan-' + key +
        '" name="satuan[]" value="' +
        satuan +
        '" ';
    item_pembelian += '</div>';
...
document.getElementById('kategori-0').addEventListener('change', function() {
    var selectedKategori = this.value;
    if (selectedKategori) {
        $('#modal-datapart').modal('show');
    }
});
    ...
    $('#kategori').change(function() {
        ...
        if (selectedValue === 'oli') {
            ...
            $('#example1 tbody tr').each(function() {
                var rowKategori = $(this).data('kategori-0');
                if (rowKategori !== 'oli') {
                    $(this)
                        .hide();
                } else {
...
function getSelectedData(rowIndex) {
    ...
    $('#kategori-' + rowIndex).val(kategori);
    $('#kode_partdetail-' + rowIndex).val(kode_partdetail);
    $('#nama_barang-' + rowIndex).val(nama_barang);
    $('#satuan-' + rowIndex).val(satuan);
