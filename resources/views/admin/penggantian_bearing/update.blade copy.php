                            ...
                            <div class="col">
                                ...
                                <div class="row mb-5">
                                    <div class="row">
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing1a == 'belum penggantian')
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-1" src="{{ asset('storage/uploads/karyawan/T1.png') }}"
                                        ...
                                        <div class="form-group mt-5" style="text-align: center;">
                                            <label>Axle 1</label>
                                            <div class="">
                                                <img class="mt-1" src="{{ asset('storage/uploads/karyawan/axle.png') }}"
                                                    alt="AdminLTELogo" height="20" width="200">
                                            </div>
                                        </div>
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing1b == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-1" src="{{ asset('storage/uploads/karyawan/T2.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-5">
                                    <div class="row">
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing2a == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T3.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing2b == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T4.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-5">
                                    <div class="row">
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing3a == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T5.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing3b == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T6.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="layout_tronton" class="row mb-5">
                                    <div class="row">
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing4a == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T7.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing4b == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T8.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="layout_trailer_engkel" class="row mb-5">
                                    <div class="row">
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing5a == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T9.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing5b == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T10.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="layout_trailer_tronton" class="row mb-5">
                                    <div class="row">
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing6a == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T11.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-2" style="text-align: center;">
                                            @if ($kendaraan->bearing->isNotEmpty() &&
                                            $kendaraan->bearing->first()->status_bearing6b == 'belum penggantian')
                                            <img src="{{ asset('storage/uploads/indikator/merah.png') }}"
                                                alt="AdminLTELogo" height="20" width="20">
                                            @else
                                            <img src="{{ asset('storage/uploads/indikator/hijau.png') }}"
                                            ...
                                            @endif
                                            <div>
                                                <img class="mt-2" src="{{ asset('storage/uploads/karyawan/T12.png') }}"
                                                    alt="AdminLTELogo" height="100" width="40">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tbody id="tabel-pembelian">
                                    ...
                                    <tr id="pembelian-0">
                                        ...
                                        <td onclick="addPart(0)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-0" name="kode_barang[0]"
                                        ...
                                        <td onclick="addPart(0)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-0" name="nama_barang[0]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-0" name="jumlah[0]" value="{{ old('jumlah.0') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                        ...
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-0" name="spareparts_id[0]"
                                        ...
                                        <td onclick="addParts(0)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-0" name="kode_grease[0]"
                                        ...
                                        <td onclick="addParts(0)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-0" name="nama_grease[0]"
                                        ...
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(0)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                    ...
                                    <tr id="pembelian-1">
                                        ...
                                        <td onclick="addPart(1)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-1" name="kode_barang[1]"
                                        ...
                                        <td onclick="addPart(1)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-1" name="nama_barang[1]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-1" name="jumlah[1]" value="{{ old('jumlah.1') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(1)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-1" name="spareparts_id[1]"
                                        ...
                                        <td onclick="addParts(1)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-1" name="kode_grease[1]"
                                        ...
                                        <td onclick="addParts(1)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-1" name="nama_grease[1]"
                                        ...
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(1)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                    ...
                                    <tr id="pembelian-2">
                                        ...
                                        <td onclick="addPart(2)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-2" name="kode_barang[2]"
                                        ...
                                        <td onclick="addPart(2)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-2" name="nama_barang[2]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-2" name="jumlah[2]" value="{{ old('jumlah.2') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(2)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-2" name="spareparts_id[2]"
                                        ...
                                        <td onclick="addParts(2)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-2" name="kode_grease[2]"
                                        ...
                                        <td onclick="addParts(2)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-2" name="nama_grease[2]"
                                        ...
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(2)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="pembelian-3">
                                        ...
                                        <td onclick="addPart(3)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-3" name="kode_barang[3]"
                                        ...
                                        <td onclick="addPart(3)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-3" name="nama_barang[3]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-3" name="jumlah[3]" value="{{ old('jumlah.3') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(3)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-3" name="spareparts_id[3]"
                                        ...
                                        <td onclick="addParts(3)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-3" name="kode_grease[3]"
                                        ...
                                        <td onclick="addParts(3)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-3" name="nama_grease[3]"
                                        ...
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(3)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="pembelian-4">
                                        ...
                                        <td onclick="addPart(4)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-4" name="kode_barang[4]"
                                        ...
                                        <td onclick="addPart(4)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-4" name="nama_barang[4]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-4" name="jumlah[4]" value="{{ old('jumlah.4') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(4)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-4" name="spareparts_id[4]"
                                        ...
                                        <td onclick="addParts(4)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-4" name="kode_grease[4]"
                                        ...
                                        <td onclick="addParts(4)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-4" name="nama_grease[4]"
                                        ...
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(4)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="pembelian-5">
                                        ...
                                        <td onclick="addPart(5)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-5" name="kode_barang[5]"
                                        ...
                                        <td onclick="addPart(5)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-5" name="nama_barang[5]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-5" name="jumlah[5]" value="{{ old('jumlah.5') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(5)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-5" name="spareparts_id[5]"
                                        ...
                                        <td onclick="addParts(5)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-5" name="kode_grease[5]"
                                        ...
                                        <td onclick="addParts(5)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-5" name="nama_grease[5]"
                                        ...
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(5)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    {{-- axle 4a  --}}
                                    <tr id="pembelian-6">
                                        <td style="width: 70px; font-size:14px" class="text-center" id="urutan">7
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                        ...
                                        <td onclick="addPart(6)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-6" name="kode_barang[6]"
                                        ...
                                        <td onclick="addPart(6)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-6" name="nama_barang[6]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-6" name="jumlah[6]" value="{{ old('jumlah.6') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(6)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-6" name="spareparts_id[6]"
                                        ...
                                        <td onclick="addParts(6)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-6" name="kode_grease[6]"
                                        ...
                                        <td onclick="addParts(6)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-6" name="nama_grease[6]"
                                        ...
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(6)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    {{-- axle 4b --}}
                                    <tr id="pembelian-7">
                                        <td style="width: 70px; font-size:14px" class="text-center" id="urutan">8
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                        ...
                                        <td onclick="addPart(7)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-7" name="kode_barang[7]"
                                        ...
                                        <td onclick="addPart(7)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-7" name="nama_barang[7]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-7" name="jumlah[7]" value="{{ old('jumlah.7') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(7)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-7" name="spareparts_id[7]"
                                        ...
                                        <td onclick="addParts(7)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-7" name="kode_grease[7]"
                                                    value="{{ old('kode_grease.7') }}">
                                            </div>
                                        </td>
                                        <td onclick="addParts(7)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-7" name="nama_grease[7]"
                                                    value="{{ old('nama_grease.7') }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah_grease-7" name="jumlah_grease[7]"
                                                    value="{{ old('jumlah_grease.7') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(7)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    {{-- axle 5a  --}}
                                    <tr id="pembelian-8">
                                        <td style="width: 70px; font-size:14px" class="text-center" id="urutan">9
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="sparepart_id-8" name="sparepart_id[8]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" readonly
                                                        class="form-control" id="kategori-8" name="kategori[8]"
                                                        value="Axle 5A">
                                                </div>
                                            </div>
                                        </td>
                                        <td onclick="addPart(8)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-8" name="kode_barang[8]"
                                                    value="{{ old('kode_barang.8') }}">
                                            </div>
                                        </td>
                                        <td onclick="addPart(8)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-8" name="nama_barang[8]"
                                                    value="{{ old('nama_barang.8') }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-8" name="jumlah[8]" value="{{ old('jumlah.8') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(8)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-8" name="spareparts_id[8]"
                                        ...
                                        <td onclick="addParts(8)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-8" name="kode_grease[8]"
                                                    value="{{ old('kode_grease.8') }}">
                                            </div>
                                        </td>
                                        <td onclick="addParts(8)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-8" name="nama_grease[8]"
                                                    value="{{ old('nama_grease.8') }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah_grease-8" name="jumlah_grease[8]"
                                                    value="{{ old('jumlah_grease.8') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(8)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    {{-- axle 5b --}}
                                    <tr id="pembelian-9">
                                        <td style="width: 70px; font-size:14px" class="text-center" id="urutan">10
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="sparepart_id-9" name="sparepart_id[9]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" readonly
                                                        class="form-control" id="kategori-9" name="kategori[9]"
                                                        value="Axle 5B">
                                                </div>
                                            </div>
                                        </td>
                                        <td onclick="addPart(9)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-9" name="kode_barang[9]"
                                                    value="{{ old('kode_barang.9') }}">
                                            </div>
                                        </td>
                                        <td onclick="addPart(9)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-9" name="nama_barang[9]"
                                                    value="{{ old('nama_barang.9') }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-9" name="jumlah[9]" value="{{ old('jumlah.9') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(9)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-9" name="spareparts_id[9]"
                                        ...
                                        <td onclick="addParts(9)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-9" name="kode_grease[9]"
                                                    value="{{ old('kode_grease.9') }}">
                                            </div>
                                        </td>
                                        <td onclick="addParts(9)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-9" name="nama_grease[9]"
                                                    value="{{ old('nama_grease.9') }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah_grease-9" name="jumlah_grease[9]"
                                                    value="{{ old('jumlah_grease.9') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(9)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    {{-- axle 6a  --}}
                                    <tr id="pembelian-10">
                                        <td style="width: 70px; font-size:14px" class="text-center" id="urutan">11
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="sparepart_id-10" name="sparepart_id[10]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" readonly
                                                        class="form-control" id="kategori-10" name="kategori[10]"
                                                        value="Axle 6A">
                                                </div>
                                            </div>
                                        </td>
                                        <td onclick="addPart(10)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-10" name="kode_barang[10]"
                                        ...
                                        <td onclick="addPart(10)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-10" name="nama_barang[10]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-10" name="jumlah[10]" value="{{ old('jumlah.10') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(10)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-10" name="spareparts_id[10]"
                                        ...
                                        <td onclick="addParts(10)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-10" name="kode_grease[10]"
                                        ...
                                        <td onclick="addParts(10)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-10" name="nama_grease[10]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah_grease-10" name="jumlah_grease[10]"
                                                    value="{{ old('jumlah_grease.10') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(10)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    {{-- axle 6b --}}
                                    <tr id="pembelian-11">
                                        <td style="width: 70px; font-size:14px" class="text-center" id="urutan">12
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="sparepart_id-11" name="sparepart_id[11]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" readonly
                                                        class="form-control" id="kategori-11" name="kategori[11]"
                                                        value="Axle 6B">
                                                </div>
                                            </div>
                                        </td>
                                        <td onclick="addPart(11)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_barang-11" name="kode_barang[11]"
                                        ...
                                        <td onclick="addPart(11)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_barang-11" name="nama_barang[11]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah-11" name="jumlah[11]" value="{{ old('jumlah.11') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addPart(11)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                        <td hidden>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="spareparts_id-11" name="spareparts_id[11]"
                                        ...
                                        <td onclick="addParts(11)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="kode_grease-11" name="kode_grease[11]"
                                        ...
                                        <td onclick="addParts(11)">
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly class="form-control"
                                                    id="nama_grease-11" name="nama_grease[11]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    id="jumlah_grease-11" name="jumlah_grease[11]"
                                                    value="{{ old('jumlah_grease.11') }}">
                                            </div>
                                        </td>
                                        <td style="width: 50px">
                                            <button type="button" class="btn btn-primary btn-sm" onclick="addParts(11)">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
                ...
                <div class="modal-body">
                    ...
                    <table id="datatables2" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr data-sparepart_id="{{ $part->id }}" data-kode_barang="{{ $part->kode_partdetail }}"
