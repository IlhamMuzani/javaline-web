...
@section('content')
    ...
    <script>
        function removeRow(index) {
            // Ambil baris yang sesuai dengan index
            var row = document.getElementById("pembelian-" + index);
            if (row) {
                // Log informasi tentang baris yang akan dihapus
        ...
        function updateOrder() {
            ...
            // Update urutan setiap baris
            for (var i = 0; i < rows.length; i++) {
                var urutanCell = rows[i].querySelector("#urutan");
                if (urutanCell) {
                    // Ubah konten urutan sesuai dengan urutan baru
                    urutanCell.textContent = i + 1; // Mulai dari 1
                }
            }
        }
    </script>
