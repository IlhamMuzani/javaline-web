...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/alamat_bongkar') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Tujuan Bongkar</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="form-group" style="flex: 8;">
                            ...
                            <div class="form-group">
                                ...
                                <input style="font-size: 14px" type="text" class="form-control" id="telp"
                                    name="telp" placeholder="Masukan no telp" value="{{ old('telp') }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input style="font-size: 14px" type="text" class="form-control" id="alamat"
                                    name="alamat" placeholder="masukkan tujuan bongkar" value="{{ old('alamat') }}">
                            </div>
                            <div>
                                ...
                                <div class="form-group d-flex">
                                    <input onclick="showCategoryLokasi(this.value)" class="form-control" id="nama_lokasi"
                                        name="nama_lokasi" type="text" placeholder="" value="{{ old('nama_lokasi') }}"
