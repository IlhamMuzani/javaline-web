...
@section('content')
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="text" readonly
                                                    ...
                                                    name="total_faktur[]"
                                                    value="{{ number_format($detail['total_faktur'], 0, ',', '.') }}">
                                        ...
                                        <td>
                                            <div class="form-group d-flex">
                                                <input hidden class="form-control"
                                                    ...
                                                    name="nota_return_id[]"
                                                    value="{{ $detail['nota_return_id'] }}" type="text" readonly
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" readonly type="text"
                                                    ...
                                                    name="total_return[]"
                                                    value="{{ number_format($detail['total_return'], 0, ',', '.') }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                            ...
                            <div class="col-md-6" style="margin-left: 89px">
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; font-size: 14px" type="text" class="form-control"
                                        ...
                                        value="{{ old('totalpenjualan', number_format($inquery->totalpenjualan, 0, ',', '.')) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; font-size: 14px" type="text" class="form-control"
                                        ...
                                        value="{{ old('dp', number_format($inquery->dp, 0, ',', '.')) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; font-size: 14px" type="text" class="form-control"
                                        ...
                                        value="{{ old('potonganselisih', number_format($inquery->potonganselisih, 0, ',', '.')) }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; font-size: 14px" type="text" class="form-control"
                                        ...
                                        value="{{ old('selisih', number_format($inquery->selisih, 0, ',', '.')) }}"
                                        placeholder="">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function itemPembelian(identifier, key, value = null) {
            ...
            item_pembelian += '<input hidden class="form-control" id="nota_return_id-' + key +
