...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_fakturpelunasan') }}">Inquery Faktur
                                pelunasan</a></li>
                                ...
                                @foreach ($details as $detail)
                                    <tr id="pembelian-{{ $loop->index }}">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" readonly type="text"
                                                    class="form-control" id="tanggal_faktur-{{ $loop->index }}"
                                                    name="tanggal_faktur[]" value="{{ $detail['tanggal_faktur'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="number" readonly
                                                    class="form-control" id="total_faktur-{{ $loop->index }}"
                                                    name="total_faktur[]" value="{{ $detail['total_faktur'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group d-flex">
                                                <input hidden class="form-control"
                                                    id="return_ekspedisi_id-{{ $loop->index }}"
                                                    name="return_ekspedisi_id[]"
                                                    value="{{ $detail['return_ekspedisi_id'] }}" type="text" readonly
                                                    style="margin-right: 10px; font-size:14px" />
                                                <input class="form-control" id="kode_return-{{ $loop->index }}"
                                                    name="kode_return[]" value="{{ $detail['kode_return'] }}"
                                                    type="text" readonly style="margin-right: 10px; font-size:14px" />
                                                <button class="btn btn-primary btn-sm" type="button"
                                                    onclick="Return({{ $loop->index }})">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" readonly type="text"
                                                    class="form-control" id="tanggal_return-{{ $loop->index }}"
                                                    name="tanggal_return[]" value="{{ $detail['tanggal_return'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" readonly type="number"
                                                    class="form-control" id="total_return-{{ $loop->index }}"
                                                    name="total_return[]" value="{{ $detail['total_return'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="number" readonly
                                                    ...
                                                    oninput="updateTotalPembayaran()" value="{{ $detail['total'] }}">
                                            </div>
                                        </td>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input style="font-size:14px" type="text" class="form-control"
                                                    ...
                                                    value="{{ old('ongkos_bongkar', $inquery->ongkos_bongkar) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-size: 14px" type="text" class="form-control" id="nominal"
                                        ...
                                        value="{{ old('nominal', $inquery->nominal) }}">
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-left: 89px">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; font-size: 14px" type="text" class="form-control"
                                        id="hasilDP" readonly name="selisih"
                                        value="{{ old('selisih', $inquery->selisih) }}" placeholder="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($fakturs as $faktur)
                                    <tr data-id="{{ $faktur->id }}" data-kode_faktur="{{ $faktur->kode_faktur }}"
                                        ...
                                        data-no_pol="{{ $faktur->detail_faktur->first()->kendaraan->no_pol }}"
                        ...
                        <table id="datatables6" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($returns as $return)
                                    <tr data-id="{{ $return->id }}" data-kode_return="{{ $return->kode_return }}"
    ...
    <script>
        ...
        function itemPembelian(identifier, key, value = null) {
            ...
            if (value !== null) {
                ...
                return_ekspedisi_id = value.return_ekspedisi_id;
            ...
            item_pembelian += '<div class="form-group">'
            item_pembelian +=
                '<input type="text" class="form-control" style="font-size:14px" readonly id="tanggal_faktur-' + key +
                '" name="tanggal_faktur[]" value="' +
                tanggal_faktur +
                '" ';
            item_pembelian += '</div>';
            item_pembelian += '</td>';
            ...
            item_pembelian += '<input hidden class="form-control" id="return_ekspedisi_id-' + key +
                '" name="return_ekspedisi_id[]" value="' + return_ekspedisi_id +
                '" type="text" readonly style="margin-right: 10px; font-size:14px" />';
            item_pembelian += '<input class="form-control" id="kode_return-' + key +
                '" name="kode_return[]" value="' + kode_return +
                '" type="text" readonly style="margin-right: 10px; font-size:14px" />';
            item_pembelian += '<button class="btn btn-primary btn-sm" type="button" onclick="Return(' + key + ')">';
    ...
    <script>
        ...
        function getFaktur(rowIndex) {
            ...
            var totalReturn = parseFloat($('#total_return-' + activeSpecificationIndex).val()) || 0;

            var difference = total_tarif - totalReturn;
            $('#total_faktur-' + activeSpecificationIndex).val(difference);
            ...
            $('#total_faktur-' + activeSpecificationIndex).val(total_tarif);


            $('#total-' + activeSpecificationIndex).val(difference);
        ...
        function getReturn(rowIndex) {
            ...
            $('#return_ekspedisi_id-' + activeSpecificationIndexs).val(return_ekspedisi_id);
            $('#kode_return-' + activeSpecificationIndexs).val(kode_return);
            $('#tanggal_return-' + activeSpecificationIndexs).val(tanggal_awal);
            $('#total_return-' + activeSpecificationIndexs).val(grand_total);
    ...
    <script>
        ...
        function PenyamaanDP() {
            ...
            // Jika terjadi kesalahan simpan, pertahankan nilai input
            // Anda perlu menyesuaikan cara Anda menangani kegagalan simpan di sisi server
            // Misalnya, jika Anda menggunakan formulir Blade di Laravel, Anda dapat memeriksa old('potongan') di PHP
            // dan menetapkan nilainya ke dalam input jika ada.

            // Contoh penggunaan old('potongan') di Blade Laravel:
            var oldPotongan = "{{ old('potongan') }}";
            if (oldPotongan !== '') {
                potonganInput.value = oldPotongan;

                // Jika old('potongan') tidak kosong, Anda mungkin juga ingin memperbarui nilai potonganselisih sesuai.
                var formattedOldValue = formatRupiah(oldPotongan);
                potonganselisihInput.value = formattedOldValue;
            }
        }

        // Panggil fungsi PenyamaanDP untuk menginisialisasi
        ...
        function OngkosBongkar() {
            ...
            // Set nilai default untuk dp saat halaman dimuat
            ...
            ongkosBongkarInput.addEventListener('input', function() {
                ...
                // Jika input ongkos_bongkar kosong, atur nilai dp ke 0
                if (potonganValue === '') {
                    dpInput.value = '0';
                } else {
                    var formattedValue = formatRupiah(potonganValue);
            ...
            // Jika terjadi kesalahan simpan, pertahankan nilai input
            // Anda perlu menyesuaikan cara Anda menangani kegagalan simpan di sisi server
            // Misalnya, jika Anda menggunakan formulir Blade di Laravel, Anda dapat memeriksa old('ongkos_bongkar') di PHP
            // dan menetapkan nilainya ke dalam input jika ada.

            // Contoh penggunaan old('ongkos_bongkar') di Blade Laravel:
            var oldOngkosBongkar = "{{ old('ongkos_bongkar') }}";
            if (oldOngkosBongkar !== '') {
                ongkosBongkarInput.value = oldOngkosBongkar;

                // Jika old('ongkos_bongkar') tidak kosong, Anda mungkin juga ingin memperbarui nilai dp sesuai.
                var formattedOldValue = formatRupiah(oldOngkosBongkar);
                dpInput.value = formattedOldValue;
            }
        }

        // Panggil fungsi OngkosBongkar untuk menginisialisasi
