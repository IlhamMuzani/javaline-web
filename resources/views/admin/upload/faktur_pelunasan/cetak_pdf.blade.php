        ...
        @foreach ($details as $item)
            <tr>
                ...
                <td class="info-text info-left" style="font-size: 13px; text-align: right;">
                    {{ number_format($item->total_faktur, 0, ',', '.') }}
                </td>
                ...
                <table>
                    @if ($cetakpdf->kategori == 'Bilyet Giro')
                        ...
                        <tr>
                            ...
                            <td class="info-column">
                                <span class="info-item"
                                    style="font-size: 13px;">{{ number_format($cetakpdf->nominal, 0, ',', '.') }}</span>
                            </td>
                        </tr>
                    @endif
            ...
            <td style="width: 70%;">
                <table style="width: 100%;" cellpadding="2" cellspacing="0">
                    <tr>
                        ...
                        <td class="td" style="text-align: right; font-size: 13px;">
                            {{ number_format($cetakpdf->potongan, 0, ',', '.') }}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td" style="text-align: right; font-size: 13px;">
                            {{ number_format($cetakpdf->ongkos_bongkar, 0, ',', '.') }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left; padding: 0px; font-size: 13px;width: 30%;">
                            Total Tagihan</td>
                        <td class="td" style="text-align: right; font-size: 13px;">
                            {{ number_format($cetakpdf->totalpenjualan, 0, ',', '.') }}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td" style="text-align: right; font-size: 13px;">
                            {{ number_format($cetakpdf->totalpembayaran, 0, ',', '.') }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6" style="padding: 0px; position: relative;">
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left; padding: 0px; font-size: 13px;width: 30%;">
                            Kekurangan Bayar</td>
                        <td class="td" style="text-align: right; font-size: 13px;">
                            {{ number_format($cetakpdf->selisih, 0, ',', '.') }}
                        </td>
                    </tr>
                </table>
            </td>
