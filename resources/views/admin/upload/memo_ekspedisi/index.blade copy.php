                                    ...
                                    <tbody id="tabel-pembelian">
                                        <tr id="pembelian-0">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" class="form-control"
                                                        readonly id="kode_biaya" name="kode_biaya" value="{{ old('kode_biaya') }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" class="form-control"
                                                        readonly id="nama_biaya" name="nama_biaya" value="{{ old('nama_biaya') }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" class="form-control"
                                                        id="nominal" readonly name="nominal" value="{{ old('nominal') }}">
                                                </div>
                                            </td>
                                            <td style="width: 50px">
                                    ...
                                    <tbody id="tabel-potongan">
                                        <tr id="potongan-0">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" class="form-control"
                                                        readonly id="kode_potongan" name="kode_potongan" value="{{ old('kode_potongan') }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" class="form-control"
                                                        readonly id="keteranganpotongan" name="keterangan_potongan" value="{{ old('keterangan_potongan') }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input style="font-size:14px" type="text" class="form-control"
                                                        id="nominalpotongan" readonly name="nominal_potongan" value="{{ old('nominal_potongan') }}">
                                                </div>
                                            </td>
                                            <td style="width: 50px">
                                                <button type="button" class="btn btn-primary btn-sm"
