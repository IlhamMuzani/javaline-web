...
<body style="margin: 0; padding: 0;">
    ...
    <table cellpadding="2" cellspacing="0">
        <tr>
            <td class="text-align: left" style="font-size: 15px; display: block;">Nama Pelanggan</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
                    :{{ $cetakpdf->nama_pelanggan }} </span>
                <br>
            </td>
            <td class="text-align: left" style="font-size: 15px; margin-left: 40px; display: block;">No Mobil</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
        ...
        <tr>
            <td style="font-size: 15px; display: block;">Alamat</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
            ...
            <td style="font-size: 15px; margin-left: 40px; display: block;">Kode Sopir</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
        ...
        <tr>
            <td style="font-size: 15px; display: block;">Telp / Hp</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
            ...
            <td style="font-size: 15px; margin-left: 40px; display: block;">Nama Sopir</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
        ...
        <tr>
            <td style="font-size: 15px; display: block;">ID Pelanggan</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
            ...
            <td style="font-size: 15px; margin-left: 40px; display: block;">Telp / Hp</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
                    :{{ $cetakpdf->telp }}</span>
                <br>
