...
<body style="margin: 0; padding: 0;">
    <table cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="text-align: left" style="font-size: 15px; margin-left: 40px; display: block;">Nama Pelanggan</td>
        ...
        <tr>
            ...
            <td style="font-size: 15px; margin-left: 40px; display: block;">Alamat</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
        ...
        <tr>
            ...
            <td style="font-size: 15px; margin-left: 40px; display: block;">ID Pelanggan</td>
