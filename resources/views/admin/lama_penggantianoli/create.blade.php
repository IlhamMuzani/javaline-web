...
@section('title', 'Tambah Lama Penggantian Oli')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/lama_penggantianoli') }}">Lama Penggantian Oli</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/lama_penggantianoli') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Lama Penggantian Oli</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="km_oli" name="km_oli"
                                placeholder="masukkan km oli" value="{{ old('km_oli') }}" oninput="formatRupiah(this)">
                        </div>
                    </div>
