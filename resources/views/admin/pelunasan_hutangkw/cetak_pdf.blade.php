...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">PELUNASAN HUTANG KARYAWAN</span>
        <br>
        <br>
    </div>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td style="text-align: right; padding: 0px; font-size: 15px; font-weight:bold">Sisa Hutang :
                <span>
