...
@section('title', 'Deposit karyawan')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Deposit karyawan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/deposit_driver') }}">Deposit karyawan</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/pelunasan-hutangkw') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kategori" name="kategori" readonly
                                placeholder="" value="Pemasukan Deposit">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_karyawan" id="nama_lengkap" readonly
                                placeholder="" value="{{ old('nama_karyawan') }}">
                        </div>
                        <div class="form-group" hidden>
                ...
                <div class="card">
                    <div id="pemasukan">
                        <div class="card-header">
                            <h3 class="card-title">Pemasukan Deposit karyawan</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="sisa_saldo">Hutang</label>
                                        <input style="text-align: end" type="text" class="form-control" readonly
                                            id="sisa_saldo" name="sisa_saldo" placeholder=""
                                            value="{{ old('sisa_saldo') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input style="text-align: end;margin:right:10px" type="text"
                                            class="form-control" id="saldo_masuk" readonly name="saldo_masuk"
                                            value="{{ old('saldo_masuk') }}" placeholder="">
                                    </div>
                                    <hr
                    ...
                    {{-- <div id="pengambilan">
                        <div class="card-header">
                            <h3 class="card-title">Pengambilan Deposit karyawan</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
