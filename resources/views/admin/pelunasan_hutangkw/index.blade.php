...
@section('title', 'Pelunasan Hutang Karyawan')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pelunasan Hutang Karyawan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Pelunasan Hutang Karyawan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Pelunasan Hutang Karyawan</h3>
                    <div class="float-right">
                        <a href="{{ url('admin/pelunasan-hutangkw/create') }}" class="btn btn-primary btn-sm">
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/pelunasan-hutangkw') }}";
            form.submit();
        }
    </script>
