...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Inquery Pelunasan Hutang Karyawan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Inquery Pelunasan Hutang Karyawan</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <table id="datatables66" class="table table-bordered table-striped table-hover"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th>Faktur Pelunasan Hutang Karyawan</th>
                                    <th>Tanggal</th>
                                    <th>Nama Karyawan</th>
                                    <th>Nominal</th>
                                    <th>Sisa Hutang</th>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                @if ($deposit->status == 'unpost')
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ url('admin/inquery_pelunasanhutangkw/' . $deposit->id . '/edit') }}">Update</a>

                                                    <a class="dropdown-item"
                                                        href="{{ url('admin/inquery_pelunasanhutangkw/' . $deposit->id) }}">Show</a>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/inquery_pelunasanhutangkw') }}";
            form.submit();
        }
    </script>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_pelunasanhutangkw/unpostdeposit/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_pelunasanhutangkw/postingdeposit/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
