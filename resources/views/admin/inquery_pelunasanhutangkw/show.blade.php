...
<head>
    ...
    <title>Pelunasan Hutang Karyawan</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 23px;">FAKTUR PELUNASAN HUTANG KARYAWAN</span>
        <br>
        <br>
    </div>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td style="text-align: right; padding: 0px; font-size: 17px; font-weight:bold">Sisa Hutang : Rp.
...
<div class="container">
    <a href="{{ url('admin/inquery_pelunasanhutangkw') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/pelunasan-hutangkw/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
