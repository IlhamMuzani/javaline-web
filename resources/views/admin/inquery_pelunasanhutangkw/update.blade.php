...
@section('title', 'Inquery Pelunasan Hutang Karyawan')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Pelunasan Hutang Karyawan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_pelunasanhutangkw') }}">Inquery Pelunasan
                                Hutang Karyawan</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery_pelunasanhutangkw/' . $inquery->id) }}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kode_karyawan" name="kode_karyawan" readonly
                                placeholder="" value="{{ old('kode_karyawan', $inquery->kode_karyawan) }}">
                        </div>
                        <div class="form-group">
                            <label for="nopol">Nama Karyawan</label>
                            <input type="text" class="form-control" name="nama_karyawan" id="nama_lengkap" readonly
                                placeholder="" value="{{ old('nama_karyawan', $inquery->nama_karyawan) }}">
                        </div>
                        <div class="form-group" hidden>
                ...
                <div id="pemasukan" class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pemasukan Hutang Karyawan</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function adjustDisplay(selectedKategori) {
                if (selectedKategori === "Pemasukan Inquery Pelunasan Hutang") {
                    Pemasukan.style.display = "block";
                    Pengambilan.style.display = "none";
                } else if (selectedKategori === "Pengambilan Inquery Pelunasan Hutang") {
