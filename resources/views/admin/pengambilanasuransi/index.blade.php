...
@section('title', 'Pengambilan Uang Asuransi Barang')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pengambilan Uang Asuransi Barang</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/pengambilanasuransi') }}">Faktur Pelunasan</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/pengambilanasuransi') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="sisa_asuransi">Sisa Saldo</label>
                                    <input style="text-align: end;margin:right:10px" type="text" class="form-control"
                                        id="sisa_asuransi" readonly name="sisa_asuransi"
                                        value="{{ old('sisa_asuransi', number_format($saldoTerakhir->latest()->first()->sisa_asuransi, 2, ',', '.')) }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="saldo_masuk">Pengambilan Asuransi</label>
