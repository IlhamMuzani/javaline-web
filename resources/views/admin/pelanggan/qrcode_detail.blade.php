                    ...
                    <td valign="top">
                        <table border="0" width="100%" style="padding-left: 2px; padding-right: 13px;">
                            <tbody>
                                ...
                                <tr>
                                    <td width="40%" valign="top" class="textt">Kode Pelanggan</td>
                                    <td width="2%">:</td>
                                    <td>{{ $pelanggan->kode_pelanggan }}</td>
                                </tr>
                                <tr>
                                    <td width="25%" valign="top" class="textt">Nama Pelanggan</td>
                                    <td width="2%">:</td>
                                    <td>{{ $pelanggan->nama_pell }}</td>
                                </tr>
                                <tr>
                                    <td width="25%" valign="top" class="textt">No. NPWP</td>
                                    <td width="2%">:</td>
