            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_tagihanekspedisi') }}">Inquery Tagihan
                                Ekspedisi</a></li>
            ...
            <form action="{{ url('admin/inquery_tagihanekspedisi/' . $inquery->id) }}" method="POST"
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">perbarui Tagihan Ekspedisi</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                @foreach ($details as $detail)
                                    <tr id="pembelian-{{ $loop->index }}">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" readonly type="text"
                                                    class="form-control" id="kode_faktur-0" name="kode_faktur[]"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" readonly type="text"
                                                    class="form-control" id="no_memo-0" name="no_memo[]"
                                                    value="{{ $detail['no_memo'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" readonly type="text"
                                                    class="form-control" id="harga-0" name="harga[]"
                                                    value="{{ $detail['harga'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" readonly type="text"
                                                    class="form-control" id="total-0" name="total[]"
                                                    value="{{ $detail['total'] }}">
                                            </div>
                                        </td>
