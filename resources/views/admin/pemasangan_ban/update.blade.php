...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/ban/' . $ban->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="no_seri" name="no_seri"
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="kondisi_ban" name="kondisi_ban">
                                    ...
                                    <option value="baru" {{ old('kondisi_ban', $ban->kondisi_ban) == 'baru' ? 'selected' : null }}>
                                        BARU</option>
                                    <option value="bekas" {{ old('kondisi_ban', $ban->kondisi_ban) == 'bekas' ? 'selected' : null }}>
                                        BEKAS</option>
                                    <option value="kanisir" {{ old('kondisi_ban', $ban->kondisi_ban) == 'kanisir' ? 'selected' : null }}>
                                        KANISIR</option>
                                    <option value="afkir" {{ old('kondisi_ban', $ban->kondisi_ban) == 'afkir' ? 'selected' : null }}>
                                        AFKIR</option>
                                </select>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="target" class="form-control" id="target_km_ban" name="target_km_ban"
                                        placeholder="Masukan target km" value="{{ old('target_km_ban', $ban->target_km_ban) }}">
                                    </select>
                                </div>
                            </div>
                        </div>
