...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pelunasan Per Invoice</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/faktur_pelunasanperfaktur') }}">Faktur
                                pelunasan</a></li>
                            ...
                            <div class="form-group" style="flex: 8;">
                                <div class="col-md-0 mb-3">
                                    ...
                                    <select class="custom-select form-control" id="kategori" name="kategori">
                                        ...
                                        <option value="pelunasan2"selected>Pelunasan Per Invoice</option>
