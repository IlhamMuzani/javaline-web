...
@section('title', 'Tambah User Driver')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">User Driver</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/userdriver') }}">User Driver</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="{{ url('admin/userdriver') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card-body">
                        <div class="form-group" style="flex: 8;"> <!-- Adjusted flex value -->
                            ...
                            <select class="select2bs4 select2-hidden-accessible" name="karyawan_id"
                                data-placeholder="Cari Driver.." style="width: 100%;" data-select2-id="23" tabindex="-1"
