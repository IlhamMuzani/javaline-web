...
@section('title', 'Inquery Faktur Penerimaan Kas Kecil')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Faktur Penerimaan Kas Kecil</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_penerimaankaskecil') }}">Inquery Faktur
                                Pelunasan</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery_penerimaankaskecil/' . $inquery->id) }}" method="POST"
