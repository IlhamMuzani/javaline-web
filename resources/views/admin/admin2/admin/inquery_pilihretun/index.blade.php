...
@section('title', 'Pilih Inquery Return Ekspedisi')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Pilih Inquery Return Ekspedisi</h4>
                        ...
                        <form id="memoForm" enctype="multipart/form-data" autocomplete="off" method="post">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Pilih Inquery Return Ekspedisi</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="memoPerjalanan">
                                            Inquery Surat Penerimaan Return Barang
                                        </label>
                                    </div>
                                    <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="penjualan">
                                            Inquery Penjualan Return Barang
                                        </label>
                                    </div>
                                </div>
                            </div>
