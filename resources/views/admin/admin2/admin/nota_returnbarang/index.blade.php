...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group d-flex">
                            <input class="form-control" hidden id="return_id" name="return_ekspedisi_id" type="text" placeholder=""
                                value="{{ old('return_ekspedisi_id') }}" readonly style="margin-right: 10px; font-size:14px" />
                            <input class="form-control" id="kode_return" name="kode_return" type="text"
                                placeholder="" value="{{ old('kode_return') }}" readonly
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input style="font-size:14px; text-align:end" type="number" class="form-control"
    ...
    <script>
        ...
        function GetReturn(Return_id, KodeReturn, Pelanggan_id, KodePelanggan, NamaPell, Telpel, AlamatPelanggan, Kendaraan_id, Nokabin,
