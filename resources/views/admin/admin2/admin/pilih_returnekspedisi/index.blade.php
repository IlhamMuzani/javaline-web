...
@section('title', 'Pilih Return Ekspedisi')
...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Pilih Return Ekspedisi</h4>
                        ...
                        <form id="memoForm" enctype="multipart/form-data" autocomplete="off" method="post">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Pilih Return Ekspedisi</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="memoPerjalanan">
                                            Surat Penerimaan Return Barang
                                        </label>
                                    </div>
                                    <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="memo_type" id="memopenjualan"
                                            value="penjualan">
                                        <label class="form-check-label" for="memopenjualan">
                                            Faktur Penjualan Return Barang
                                        </label>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.getElementById('lanjutkanBtn').addEventListener('click', function() {
            ...
            switch (memoType) {
                case 'perjalanan':
                    window.location.href = "{{ url('admin/return_ekspedisi') }}";
                    break;
                case 'borong':
                    window.location.href = "{{ url('admin/nota_returnbarang') }}";
                    break;
                case 'penjualan':
                    window.location.href = "{{ url('admin/faktur_penjualanreturn') }}";
                    break;
                default:
