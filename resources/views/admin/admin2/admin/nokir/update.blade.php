                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="nama_pemilik" name="nama_pemilik">
                                ...
                                <option value="PT JAVA LINE LOGISTICS"
                                    {{ old('nama_pemilik', $nokir->nama_pemilik) == 'PT JAVA LINE LOGISTICS' ? 'selected' : null }}>
                                    PT JAVA LINE LOGISTICS</option>
                                <option value="PT. BINTANG KENCANA TRASINDO"
                                    {{ old('nama_pemilik', $nokir->nama_pemilik) == 'PT. BINTANG KENCANA TRASINDO' ? 'selected' : null }}>
                                    PT. BINTANG KENCANA TRASINDO</option>
                                <option value="PT ELIM SEJAHTERA TRANSINDO"
                                    {{ old('nama_pemilik', $nokir->nama_pemilik) == 'PT ELIM SEJAHTERA TRANSINDO' ? 'selected' : null }}>
                                    PT ELIM SEJAHTERA TRANSINDO</option>
                            </select>
                        </div>
