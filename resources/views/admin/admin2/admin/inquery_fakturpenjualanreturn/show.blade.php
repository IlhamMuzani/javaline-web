...
<body style="margin: 0; padding: 0;">
    ...
    <table cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="text-align: left" style="font-size: 17px; margin-left: 40px; display: block;">Devisi</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
        ...
        <tr>
            ...
            <td style="font-size: 17px; margin-left: 40px; display: block;">Keterangan</td>
            <td style="text-align: left; font-size: 17px;">
                <span class="content2">
