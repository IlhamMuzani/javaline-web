...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input class="form-control" hidden id="return_id" name="return_ekspedisi_id" type="text" placeholder=""
                                value="{{ old('return_ekspedisi_id', $inquery->return_ekspedisi_id) }}" readonly
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="number" class="form-control jumlah"
                                                    id="jumlah-0" name="jumlah[]" readonly value="{{ $detail['jumlah'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
    ...
    <script>
        ...
        function itemPembelian(identifier, key, value = null) {
            ...
            item_pembelian += '<td>';
            item_pembelian += '<div class="form-group">'
            item_pembelian += '<input type="number" class="form-control jumlah" readonly style="font-size:14px" id="jumlah-' + key +
                '" name="jumlah[]" value="' +
                jumlah +
                '" ';
            item_pembelian += '</div>';
            ...
            item_pembelian += '<td>';
            item_pembelian += '<div class="form-group">'
            item_pembelian += '<input type="number" class="form-control harga" style="font-size:14px" id="diskon-' + key +
                '" name="harga[]" value="' +
                harga +
                '" ';
            item_pembelian += '</div>';
