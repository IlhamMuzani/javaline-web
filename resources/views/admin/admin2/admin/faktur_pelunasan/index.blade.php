...
@section('content')
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody id="tabel-pembelian">
                                <tr id="pembelian-0">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" readonly type="number" class="form-control"
                                                id="total_faktur-0" name="total_faktur[]">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group d-flex">
                                            <input hidden class="form-control" id="return_ekspedisi_id-0"
                                                name="return_ekspedisi_id[]" type="text" readonly
                                                style="margin-right: 10px; font-size:14px" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="margin-left: 89px">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; font-size: 14px" type="text" class="form-control"
                                        id="hasilDP" readonly name="selisih" value="{{ old('selisih') }}"
                                        placeholder="">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function itemPembelian(urutan, key, value = null) {
            ...
            item_pembelian += '<input hidden class="form-control" id="return_ekspedisi_id-' + urutan +
