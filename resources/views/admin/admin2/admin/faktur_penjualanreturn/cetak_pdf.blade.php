...
<head>
    ...
    <title>Faktur Penjualan Return Ekspedisi</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    ...
    <table cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="text-align: left" style="font-size: 15px; margin-left: 40px; display: block;">Devisi</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
                    :PT. JAVA LINE LOGISTICS </span>
                <br>
            </td>
        </tr>
        <tr>
            ...
            <td style="font-size: 15px; margin-left: 40px; display: block;">Keterangan</td>
            <td style="text-align: left; font-size: 15px;">
                <span class="content2">
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 0px; font-size: 15px;">No Mobil:
    ...
    <table style="width: 100%; border-top: 1px solid black; margin-top:7px" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: right; padding: 5px; font-size: 15px;">Diskon</td>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            <td colspan="6" style="text-align: right; padding-left: 325px; font-size: 15px;">Potongan
            </td>
            <td class="td" style="text-align: right; font-size: 15px;">
                {{ number_format($totalDiskon, 0, ',', '.') }}
            </td>
        ...
        <tr>
            <td colspan="6" style="text-align: right; padding: 0px; font-size: 15px;">Grand Total</td>
            <td class="td" style="text-align: right; font-weight: bold; font-size: 15px;">
