...
@section('title', 'Perbarui Merek Ban')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Perbarui Merek Ban</h3>
                </div>
                <!-- /.card-header -->
                <form action="{{ url('admin/merek_ban/' . $merek_ban->id) }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_merek" name="nama_merek"
                                placeholder="Masukan nama merek" value="{{ old('nama_merek', $merek_ban->nama_merek) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control" id="kendaraan_id" name="kendaraan_id">
                                ...
                                @foreach ($kendaraans as $kendaraan)
                                    <option value="{{ $kendaraan->id }}"
                                        {{ old('kendaraan_id', $merek_ban->kendaraan_id) == $kendaraan->id ? 'selected' : '' }}>
