                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-size:14px" type="text" class="form-control" id="biaya"
                                        readonly name="uang_jalan" placeholder="" value="{{ old('uang_jalan') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input style="font-size:14px" type="text" class="form-control" id="uang_jaminan"
                                        readonly name="uang_jaminan" placeholder="" value="{{ old('uang_jaminan') }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-size:14px" type="text" class="form-control"
                                        ...
                                        value="{{ old('biaya_tambahan') }}" onclick="calculateAndDisplayTotal()">
                                </div>

                                <div class="form-group">
                                    <label style="font-size:14px" for="deposit_driver">Deposit Sopir</label>
                                    <input style="font-size:14px" type="text" class="form-control"
                                        id="deposit_driver" name="deposit_driver" value="{{ old('deposit_driver') }}"
                                        placeholder="" oninput="limitInput()" onclick="calculateAndDeposit()">
                                </div>
                            ...
                            <tbody id="tabel-pembelian">
                                <tr id="pembelian-0">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control" readonly
                                                id="nama_biaya-0" name="nama_biaya[]">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                            ...
                            <tbody id="tabel-rute">
                                <tr id="rute-0">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control" readonly
                                                id="kode_rutes-0" name="kode_rutes[]">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control" readonly
                                                id="nama_rutes-0" name="nama_rutes[]">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="text" class="form-control totalrute"
                                                id="totalrute-0" name="totalrute[]" readonly>
                                        </div>
                                    </td>
                                    <td style="width: 100px">
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group" style="display: flex; align-items: center;">
                                            ...
                                            <input style="width: 300px; font-size: 14px;" id="uangjaminanss"
                                                ...
                                                name="uang_jaminans" placeholder="" value="{{ old('uang_jaminans') }}">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px; font-weight:bold" readonly type="text"
                                                ...
                                                value="{{ old('sub_total') }}" onclick="SubTotalss()">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
