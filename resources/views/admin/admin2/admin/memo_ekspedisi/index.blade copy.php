        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input style="font-size:14px" type="text" class="form-control" id="uang_jaminan" readonly name="uang_jaminan" placeholder="" value="{{ old('uang_jaminan') }}">
                </div>

                <div class="form-group">
                    <label style="font-size:14px" for="harga_tambahan">Biaya Tambahan</label>
                    <input style="font-size:14px" type="text" class="form-control" id="harga_tambahan" name="biaya_tambahan" placeholder="" value="{{ old('biaya_tambahan') }}" onclick="calculateAndDisplayTotal()">
                </div>

                <div class="form-group">
                    <label style="font-size:14px" for="deposit_driver">Deposit Sopir</label>
                    <input style="font-size:14px" type="text" class="form-control" id="deposit_driver" name="deposit_driver" value="{{ old('deposit_driver') }}" placeholder="" oninput="limitInput()" onclick="calculateAndDeposit()">
                </div>
    ...
    <div class="card" id="form_borongan">
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="tabel-rute">
                    <tr id="rute-0">
                        <td style="width: 70px; font-size:14px" class="text-center" id="urutanrute">1</td>
                        <td hidden>
                            <div class="form-group">
                                <input type="text" class="form-control" id="rute_id-0" name="rute_id[]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input style="font-size:14px" type="text" class="form-control" readonly id="kode_rutes-0" name="kode_rutes[]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input style="font-size:14px" type="text" class="form-control" readonly id="nama_rutes-0" name="nama_rutes[]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input style="font-size:14px" type="number" class="form-control harga_rute" readonly id="harga_rute-0" name="harga_rute[]" data-row-id="0">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <input style="font-size:14px" type="number" class="form-control jumlah" id="jumlah-0" name="jumlah[]" data-row-id="0">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                        ...
                        <td>
                            <div class="form-group">
                                <input style="font-size:14px" type="text" class="form-control totalrute" id="totalrute-0" name="totalrute[]" readonly>
                            </div>
                        </td>
                        <td style="width: 100px">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="form-group" style="display: flex; align-items: center;">
                                ...
                                <input style="width: 300px; font-size: 14px; margin-left:6px" type="text" class="form-control" id="depositsdriversst" readonly name="depositsdriversst" placeholder="" value="{{ old('depositsdriversst') }}">

                            </div>
                            <div class="form-group" style="display: flex; align-items: center;">
                                <label style="font-size: 14px; margin-right: 78px;" for="rute_perjalanan">Total</label>
                                <input style="width: 300px; font-size: 14px;" type="text" class="form-control text-right" id="hasilsss" readonly name="totals" placeholder="" value="{{ old('totals') }}" onclick="calculateHasilsrute()">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <input style="font-size:14px" type="text" readonly class="form-control" id="sisa_saldo" name="sisa_saldo" value="{{ old('sisa_saldo', $saldoTerakhir->latest()->first()->sisa_saldo) }}">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
    ...
    function SubTotalss() {
        ...
        if (selectedCategory === 'Memo Tambahan') {
            ...
            if (TotalPerjalanan === 2) {
                ...
                // var uangJaminanValue = biaya - 0.01 - DepositDrivers;

                var uangJaminanValue = Biaya_tambahan + UangJalan;


                $('#sub_total').val(uangJaminanValue);
        ...
        if (selectedCategory === 'Memo Borong') {
            ...
            if (TotalPerjalanan === 2) {
                ...
                $('#hasilsss').val(uangJaminanValue);

                var HasilBagi = (TotalBorong - PPh - UangJaminan - DepositDriver) / 2;
                $('#sub_total').val(HasilBagi);
