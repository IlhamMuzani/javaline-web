...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 22px;">FAKTUR PEMBELIAN BAN</span>
        <br>
        <br>
    </div>
    <table width="100%">
    ...
    <table width="100%">
        <tr>
            <td>
                <span class="info-item">No. Faktur: {{ $pembelians->kode_pembelian_ban }}</span>
                <br>
            </td>
    ...
    <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 2px;">Kode Ban</td>
            <td class="td" style="text-align: center; padding: 2px;">No. Seri</td>
            <td class="td" style="text-align: center; padding: 2px;">Ukuran</td>
        ...
        @foreach ($bans as $item)
            <tr>
                ...
                <td class="td" style="text-align: center; padding: 2px;">{{ $item->kode_ban }}</td>
        ...
        <tr>
            <td colspan="7" style="text-align: right; font-weight: bold; padding: px;">Sub Total</td>
...
<div class="container">
    <a href="{{ url('admin/pembelian_ban') }}" class="blue-button">Kembali</a>
