...
<body style="margin: 0; padding: 0;">
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <!-- Header row -->
        <tr>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 12px; width: 13%">No.
                Faktur
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 12px;width: 13%">
                Tanggal</td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 12px; width: 50%">Keterangan
            </td>
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 12px; width: 24%">Nominal</td>
        </tr>
        <!-- Separator row -->
        ...
        {{-- <tr style="color: white">
            <td colspan="2" style="text-align: right; font-weight: bold; padding: 5px; font-size: 12px;">a
            </td>
            <td style="text-align: right; font-weight: bold; padding: 5px; font-size: 12px;">a
            </td>
            <td style="text-align: right; font-weight: bold; padding: 5px; color:white; font-size: 12px;">a
            </td>
        </tr> --}}
        <tr>
            <td colspan="3" style="text-align: right; font-weight: bold; padding: 5px; font-size: 12px;">Sub Total
            </td>
