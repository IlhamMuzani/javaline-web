                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody id="tabel-potongan">
                                        ...
                                        @empty
                                            <!-- Static form fields displayed when loop is empty -->
                                            <tr id="empty-form">
                                                <td style="width: 70px; font-size:14px" class="text-center">1</td>
                                                <td hidden>
                                                    <div class="form-group" hidden>
                                                        <input type="text" class="form-control" id="nomor_seri-empty"
                                                            name="detail_ids[]" value="">
                                                    </div>
                                                </td>
                                                <td hidden>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            id="potongan_memo_id-empty" name="potongan_memo_id[]"
                                                            value="">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input style="font-size:14px" type="text" class="form-control"
                                                            readonly id="kode_potongan-empty" name="kode_potongan[]"
                                                            value="">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input style="font-size:14px" type="text" class="form-control"
                                                            readonly id="keterangan_potongan-empty"
                                                            name="keterangan_potongan[]" value="">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input style="font-size:14px" type="text" class="form-control"
                                                            readonly id="nominal_potongan-empty" name="nominal_potongan[]"
                                                            value="">
                                                    </div>
                                                </td>
                                                <td style="width: 100px">
                                                    <!-- Add button for adding new entry -->
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        onclick="addNewEntry()">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
