...
@section('content')
                                    ...
                                    <tbody id="tabel-nota">
                                        @foreach ($detailnotas as $detail)
                                            <tr id="nota-{{ $loop->index }}">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input onclick="notabons({{ $loop->index }})"
                                                            style="font-size:14px" type="text" class="form-control"
                                                            readonly id="kode_nota-{{ $loop->index }}"
                                                            name="kode_nota[]" value="{{ $detail['kode_nota'] }}">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input onclick="notabons({{ $loop->index }})"
                                                            style="font-size:14px" type="text" class="form-control"
                                                            readonly id="nama_drivernota-{{ $loop->index }}"
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input onclick="notabons({{ $loop->index }})"
                                                            style="font-size:14px" type="text" class="form-control"
                                                            id="nominal_nota-{{ $loop->index }}" readonly
                                                            name="nominal_nota[]"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6" style="color: white">
                                                        <div class="form-group">
                                                            <label style="font-size:18px; margin-top:58px" for="tarif">.
                                                                <span class="ml-3">:</span></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input style="text-align: end; font-size:14px;" type="text"
                                                                class="form-control" id="nota_bon" readonly
                                                                name="nota_bon" placeholder=""
                                                                value="{{ number_format($inquery->nota_bon, 0, ',', '.') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function updateSubTotals() {
            ...
            var Notabon = parseCurrency($('#nota_bon').val().replace(/\./g, '')) || 0;
            ...
            var Subtotal = UangJaminan - satuPersenUangJaminan - DepositDriv - Notabon;
