...
@section('title', 'Laporan Detail Kaskecil')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Detail Kaskecil</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Detail Kaskecil</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Laporan Detail Kaskecil</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <table id="datatables66" class="table table-bordered table-striped table-hover"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th style=" width: 18%">Kode Kaskecil</th>
                            ...
                            <tbody>
                                @foreach ($inquery as $pengeluaran)
                                    <tr>
                                        ...
                                        <td>{{ $pengeluaran->kode_detailakun ?? null }}</td>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/laporandetailkaskecil') }}";
            form.submit();
        }
