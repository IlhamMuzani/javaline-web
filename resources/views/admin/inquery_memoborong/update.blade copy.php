...
<section class="content">
    <div class="container-fluid">
        ...
        @endif
        <form action="{{ url('admin/inquery_memoborong/' . $inquery->id) }}" method="POST" enctype="multipart/form-data"
            autocomplete="off">
            @csrf
            @method('put')
            <div class="card">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input onclick="showCategoryModalRuts(this.value)"
                                                ...
                                                name="kode_rutes" value="{{ old('kode_rutes', $inquery->kode_rute) }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input onclick="showCategoryModalRuts(this.value)" style="font-size:14px"
                                                ...
                                                name="nama_rutes" value="{{ old('nama_rutes', $inquery->nama_rute) }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input style="font-size:14px" type="number" class="form-control jumlah"
                                                id="jumlah" name="jumlah" value="{{ old('jumlah', $inquery->jumlah) }}"
                                                data-row-id="0">
                                        </div>
                                    </td>
                                    <td>
            ...
            <div class="card">
                ...
                <td>
                    <div class="form-group">
                        <input style="font-size:14px; font-weight:bold; text-align:end" readonly type="text"
                            class="form-control" id="sub_total" name="sub_total"
                            value="{{ old('sub_total', $inquery->sub_total) }}" onclick="SubTotalss()">
                    </div>
                </td>
                </tr>
                </tbody>
