...
@section('content')
            ...
            <form action="{{ url('admin/faktur_ekspedisi') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="nomor_id" name="nomor_id" placeholder=""
                                value="{{ old('nomor_id') }}">
                        </div>
                            ...
                            <tbody>
                                @foreach ($memoEkspedisi as $memo)
                                    <tr onclick="getMemos({{ $loop->index }})" data-id="{{ $memo->id }}"
                                        ...
                                        data-memotambahan_id="{{ !empty($memo->memotambahan->first()) ? $memo->memotambahan->first()->id : '' }}"
                                        data-kode_memotambahan="{{ !empty($memo->memotambahan->first()) ? $memo->memotambahan->first()->kode_tambahan : '' }}"
                                        data-nama_drivertambahan="{{ !empty($memo->memotambahan->first()) ? $memo->memotambahan->first()->nama_driver : '' }}"
                                        data-tanggal_awaltambahan="{{ !empty($memo->memotambahan->first()) ? $memo->memotambahan->first()->tanggal_awal : '' }}"
                                        data-nama_rutetambahan="{{ !empty($memo->memotambahan->first()) ? $memo->memotambahan->first()->nama_rute : '' }}"
    ...
    <script>
        function showCategoryModalPelanggan(selectedCategory) {
            var nomorId = $('#nomor_id').val(); // Ambil nilai dari form nomor_id
