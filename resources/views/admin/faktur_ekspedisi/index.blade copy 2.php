                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="tabel-pembelian">
                            <tr id="pembelian-0">
                                ...
                                <td>
                                    <div class="form-group">
                                        <input onclick="MemoEkspedisi(0)" style="font-size:14px" type="text" readonly
                                            class="form-control" id="kode_memo-0" name="kode_memo[]">
                                    </div>
                                </td>
                                <td hidden>
                                    <div class="form-group">
                                        <input onclick="MemoEkspedisi(0)" style="font-size:14px" type="text" readonly
                                            class="form-control" id="tanggal_memo-0" name="tanggal_memo[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly type="text"
                                            class="form-control" id="nama_driver-0" name="nama_driver[]">
                                    </div>
                                </td>
                                <td hidden>
                                    <div class="form-group">
                                        <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly type="text"
                                            class="form-control" id="telp_driver-0" name="telp_driver[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly type="text"
                                            class="form-control" id="nama_rute-0" name="nama_rute[]">
                                    </div>
                                </td>
                                <td hidden>
                                    <div class="form-group">
                                        <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly type="text"
                                            class="form-control" id="kendaraan_id-0" name="kendaraan_id[]">
                                    </div>
                                </td>
                                <td hidden>
                                    <div class="form-group">
                                        <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly type="text"
                                            class="form-control" id="no_kabin-0" name="no_kabin[]">
                                    </div>
                                </td>
                                <td hidden>
                                    <div class="form-group">
                                        <input onclick="MemoEkspedisi(0)" style="font-size:14px" readonly type="text"
                                            class="form-control" id="no_pol-0" name="no_pol[]">
                                    </div>
                                </td>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="tabel-pembelian">
                            <tr id="pembelian-0">
                                <td hidden>
                                    <div class="form-group">
                                        <input onclick="Tarifs(0)" type="text" class="form-control" id="tarif_id"
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea style="font-size:14px" type="text" class="form-control" id="keterangan"
                            name="keterangan" placeholder="Masukan keterangan">{{ old('keterangan') }}</textarea>
                    </div>
                </div>
            </div>
            <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input style="text-align: end; font-size:14px;" type="text"
                                                class="form-control pph2" readonly id="pph2" name="pph" placeholder=""
                                                value="{{ old('pph') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input style="text-align: end; font-size:14px;" type="text"
                                                class="form-control sisa" readonly id="sisa" name="sisa" placeholder=""
                                                value="{{ old('sisa') }}">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table id="tables" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr onclick="getMemos({{ $loop->index }})" data-id="{{ $memo->id }}"
                                ...
                                data-nama_driver="@if ($memoEkspedisi == true) {{ $memo->nama_driver }}@else{{ $memo->nama_driver }} @endif"
                                data-tanggal_awal="@if ($memoEkspedisi == true) {{ $memo->tanggal_awal }}@else{{ $memo->tanggal_awal }} @endif"
...
//                     return true; // Continue with the loop
//                 } else {
//                     alert('Anda hanya dapat memasukkan 2 memo perjalanan dengan kode "MP"');
//                     // Prevent modal from being hidden on validation failure
//                     return false; // exit the loop if the condition is met
//                 }
//             }
...
//     // Check if the 'MP' prefix already exists in the form array
//     var mpPrefixCount = 0;
//     $('input[name^="kode_memo"]').each(function() {
//         var currentValue = $(this).val();
//         if (currentValue.startsWith('MP')) {
...
//     // Check if the kode_memo already exists in the form array
//     var kodeMemoExists = false;
//     $('input[name^="kode_memo"]').each(function() {
//         if ($(this).val() === kode_memo) {
//             kodeMemoExists = true;
...
//     if (kodeMemoExists) {
//         alert('Anda hanya dapat memasukan 2 memo perjalanan');
//         // You can handle this case accordingly (e.g., show an error message)
//     } else {
//         // Update the form fields for the active specification
//         $('#memo_ekspedisi_id-' + activeSpecificationIndex).val(memo_ekspedisi_id);
