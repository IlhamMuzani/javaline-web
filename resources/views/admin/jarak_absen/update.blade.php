...
@section('title', 'Perbarui Jarak Update Absen')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/jarak-absen') }}">Jarak Absen Update
                            </a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/jarak-absen/' . $jarak_absen->id) }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Perbarui Jarak Update Absen</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="radius" name="radius"
                                placeholder="masukkan jarak km" value="{{ old('radius', $jarak_absen->radius) }}"
