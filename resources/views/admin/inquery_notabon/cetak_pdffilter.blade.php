...
<head>
    ...
    <title>Nota Bon Uang Jalan</title>
    <style>
        html,
        body {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 18px;">NOTA BON UANG JALAN</span>
        <br>
        <br>
        <div class="text">
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <!-- Header row -->
        <tr>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">No.
            </td>
            ...
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 13px;">Nominal</td>
        </tr>
        <!-- Separator row -->
        ...
        @foreach ($notas as $item)
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 5px; font-size: 13px;">{{ $item->kode_nota }}
                </td>
                ...
                <td class="td" style="text-align: left; padding: 5px; font-size: 13px;">
                    {{ $item->karyawan->kode_karyawan ?? null }}</td>
                <td class="td" style="text-align: left; padding: 5px; font-size: 13px;">
                    {{ $item->karyawan->nama_lengkap ?? null }}</td>
