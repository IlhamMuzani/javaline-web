...
@section('title', 'Laporan Pemakaian Peralatan')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Pemakaian Peralatan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Pemakaian Peralatan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Laporan Pemakaian Peralatan</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/laporan_pemakaianperalatan') }}";
            form.submit();
        }
        ...
        function printReport() {
            ...
            if (startDate && endDate) {
                form.action = "{{ url('admin/print_pemakaianperalatan') }}" + "?start_date=" + startDate + "&end_date=" +
                    endDate;
                form.submit();
            } else {
