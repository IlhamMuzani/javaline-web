...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Invoice Faktur Sewa Kendaraan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Invoice Faktur Sewa Kendaraan</h3>
                    <div class="float-right">
                        @if (auth()->check() && auth()->user()->fitur['create invoice ekspedisi'])
                            <a href="{{ url('admin/invoice_sewakendaraan/create') }}" class="btn btn-primary btn-sm">
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/inquery_invoicesewakendaraan') }}";
            form.submit();
        }
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_invoicesewakendaraan/unpostsewa/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_invoicesewakendaraan/postingsewa/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
