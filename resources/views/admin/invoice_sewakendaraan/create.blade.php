...
@section('title', 'Invoice Faktur Sewa Kendaraan')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Invoice Faktur Sewa Kendaraan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/invoice_sewakendaraan') }}">Invoice Faktur
                                Sewa Kendaraan</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            <form action="{{ url('admin/invoice_sewakendaraan') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Invoice Faktur Sewa Kendaraan</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input onclick="showCategoryModalVendor(this.value)" style="font-size:14px"
                                            ...
                                            name="telp_vendor" placeholder="" value="{{ old('telp_vendor') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
        ...
        <div class="modal fade" id="tableRekanan" data-backdrop="static">
    ...
    <script>
        ...
        function getSelectedDataVendor(Pelanggan_id, KodePelanggan, NamaPell, AlamatPel, Telpel) {
            ...
            document.getElementById('dalamat_vendor').value = AlamatPel;
            document.getElementById('telp_vendor').value = Telpel;

            $('#vendor_id').trigger('input');

            // Close the modal (if needed)
            $('#tableRekanan').modal('hide');
        }
    </script>
        ...
        $(document).ready(function() {
            ...
            $('#kategori').on('change', function() {
                ...
                switch (selectedValue) {
                    case 'PPH':
                        window.location.href = "{{ url('admin/invoice_sewakendaraan/create') }}";
                        break;
                    case 'NON PPH':
                        window.location.href = "{{ url('admin/indexinvoice_nonpph') }}";
                        break;
                    default:
    ...
    <script>
        $(document).ready(function() {
            $('#vendor_id').on('input', function() {
                ...
                if (pelangganID) {
                    $.ajax({
                        url: "{{ url('admin/invoice_sewakendaraan/get_faktursewa') }}" + '/' +
                            pelangganID,
                        type: "GET",
                        dataType: "json",
