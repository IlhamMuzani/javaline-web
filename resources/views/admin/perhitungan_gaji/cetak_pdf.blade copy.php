                ...
                <tr>
                    ...
                    <td style="width: 95%; text-align: left;">
                        <div style="text-align: center; margin-top:20px">
                            <span style="font-weight: bold; font-size: 15px;">REKAP GAJI TEKNISI JAVA LINE LOGISTICS (
        ...
        <table style="width: 100%; border-top: 1px solid #000;" cellpadding="2" cellspacing="0">
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 2px; font-size: 9px;  font-weight:bold; width:13%">
                    NAMA LENGKAP</td>
                <td class="td" style="text-align: right; padding: 2px; font-size: 9px;  font-weight:bold; width:11% ">
                    GAPOK</td>
                ...
                <td class="td" style="text-align: center; padding: 2px; font-size: 9px; font-weight:bold; width:17%">
            ...
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 2px; font-size: 9px; border-bottom: 1px solid black;">
                    @if ($item->karyawan)
                ...
                <td class="td" style="text-align: right; padding: 2px; font-size: 9px; border-bottom: 1px solid black;">
