        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Inquery Pemasangan Aki</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    @if ($pemasangan->status == 'unpost')
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ url('admin/inquery-pemasanganaki/' . $pemasangan->id) }}">Show</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_pemasanganpart/unpostpemasangan_part/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_pemasanganpart/postingpemasangan_part/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
