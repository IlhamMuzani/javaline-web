...
<head>
    ...
    <title>Laporan Pelunasan Karyawan</title>
    <style>
        html,
        body {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        ...
        @endphp
        <span style="font-weight: bold; font-size: 22px;">LAPORAN PELUNASAN HUTANG KARYAWAN - RANGKUMAN</span>
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: right; padding: 5px; font-weight:bold; font-size: 15px;">Sisa Hutang
            </td>
        </tr>
        <!-- Separator row -->
