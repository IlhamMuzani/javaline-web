...
<head>
    ...
    <title>Laporan Memo Ekspedisi</title>
    <style>
        html,
        body {
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="font-weight: bold; text-align: center">
        <span style="font-weight: bold; font-size: 22px;">LAPORAN MEMO EKSPEDISI - RANGKUMAN</span>
        <br>
        <div class="text">
            @php
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 8;">Uang Jalan
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 8;">Uang Tambah
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 8;">Deposit</td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 8;">Adm
            </td>
