                                            ...
                                            @if ($detail['kode_biaya'] !== null)
                                                <tr id="pembelian-{{ $loop->index }}">
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input style="font-size:14px" type="text"
                                                                class="form-control" id="nominal-0" readonly
                                                                name="nominal[]" value="{{ $detail['nominal'] }}">
                                                        </div>
                                                    </td>
                                                    <td style="width: 50px">
                                        ...
                                        @if ($detail['kode_potongan'] !== null)
                                            <tr id="potongan-{{ $loop->index }}">
                                                ...
                                                <td hidden>
                                                    <div class="form-group" hidden>
                                                        <input type="text" class="form-control"
                                                            name="detail_idsx[]" value="{{ $detail['id'] }}">
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input style="font-size:14px" type="text"
                                                            class="form-control" readonly id="kode_potongan-0"
                                                            name="kode_potongan[]"
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input style="font-size:14px" type="text"
                                                            class="form-control" readonly id="keteranganpotongan-0"
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input style="font-size:14px" type="text"
                                                            class="form-control" id="nominalpotongan-0" readonly
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input style="text-align: end; font-size:14px;"
                                                            type="text" class="form-control" readonly id="uang_jaminan"
...
<script>
    ...
    function getSelectedDatarute(Rute_id, KodeRute, NamaRute, Golongan1, Golongan2, Golongan3, Golongan4, Golongan5,
        ...
        if (Golongan === 'Golongan 1') {
            ...
            var satuPersenBiaya = 0.01 * parseFloat(Golongan1);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan2);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan3);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan4);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan5);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan6);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan7);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan8);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan9);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
            ...
            document.getElementById('uangjalans').value = formattedNominal;
            var satuPersenBiaya = 0.01 * parseFloat(Golongan10);
            var formattedNominal = satuPersenBiaya.toLocaleString('id-ID');
            document.getElementById('uang_jaminan').value = formattedNominal;
...
<script>
    ...
    function limitInput() {
        ...
        if (!checkbox.checked) {
            depositInput.value = Math.max(initialValue, parseFloat(depositInput.value) || initialValue);
