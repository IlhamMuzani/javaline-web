...
<section class="content">
    <div class="container-fluid">
        ...
        <form action="{{ url('admin/inquery_memoekspedisi/' . $inquery->id) }}" method="POST"
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-size:14px" type="text" class="form-control" id="km" readonly
                                        name="km_awal" placeholder="" value="{{ old('km_awal', $inquery->km_awal) }}">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input type="text" class="form-control" id="kode_driver" readonly name="kode_driver"
                                        placeholder="" value="{{ old('kode_driver', $inquery->kode_driver) }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-size:14px" type="tex" class="form-control" id="telp" readonly
                    ...
                    <div class="col-md-4" id="form_rute">
                        <div class="card">
                            ...
                            <label style="font-size:14px" class="form-label" for="kode_rute">Kode
                                Rute</label>
                            <div class="form-group d-flex">
                                <input class="form-control" id="kode_rute" name="kode_rute" type="text" placeholder=""
                            ...
                            <div class="form-group">
                                ...
                                <input style="font-size:14px" type="text" class="form-control" id="rute_perjalanan"
                            ...
                            <div class="form-group">
                                ...
                                <input style="font-size:14px" type="text" class="form-control" id="biaya" readonly
                                ...
                                <td hidden>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="biaya_id-0" name="biaya_id[]"
                                            value="{{ $detail['biaya_id'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly
                                            id="kode_biaya-0" name="kode_biaya[]" value="{{ $detail['kode_biaya'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly
                                            id="nama_biaya-0" name="nama_biaya[]" value="{{ $detail['nama_biaya'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" id="nominal-0"
                                            readonly name="nominal[]" value="{{ $detail['nominal'] }}">
                                    </div>
                                </td>
                                <td style="width: 50px">
                                ...
                                <td hidden>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="potongan_id-0" name="potongan_id[]"
                                            value="{{ $detail['potongan_id'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly
                                            id="kode_potongan" name="kode_potongan[]"
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="tabel-rute">
                            ...
                            <tr id="rute-{{ $loop->index }}">
                                ...
                                <td hidden>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="rute_id-0" name="rute_id[]"
                                            value="{{ $detail['rute_id'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly
                                            id="kode_rutes-0" name="kode_rutes[]" value="{{ $detail['kode_rutes'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control" readonly
                                            id="nama_rutes-0" name="nama_rutes[]" value="{{ $detail['nama_rutes'] }}">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="number" class="form-control harga_rute"
                                            readonly id="harga_rute-0" name="harga_rute[]" data-row-id="0"
                                ...
                                <td>
                                    <div class="form-group">
                                        <input style="font-size:14px" type="text" class="form-control totalrute"
                                            id="totalrute-0" name="totalrute[]" value="{{ $detail['totalrute'] }}"
                                            readonly>
                                    </div>
                                </td>
                                <td style="width: 50px">
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered table-striped" id="perjalananss">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        ...
                                        <input style="width: 300px; font-size: 14px;" type="text"
                                            class="form-control text-right" id="uangjalans" readonly name="uangjalans"
                                            placeholder="" value="{{ old('uangjalans', $inquery->uang_jalan) }}">
                                        <label style="font-size: 14px; margin-right: 22px; margin-left:46px"
                                            for="rute_perjalanan">Administrasi</label>
                                        <input style="width: 300px; font-size: 14px;" type="text" class="form-control"
                                            readonly placeholder="" value="1 %">
                                    </div>
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        ...
                                        <input style="width: 300px; font-size: 14px; margin-left:6px" type="text"
                                            class="form-control" id="deposit_driver" name="deposit_driver"
                                            value="{{ old('deposit_driver') }}" placeholder="" oninput="limitInput()">
                                    </div>
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        ...
                                        <input style="width: 300px; font-size: 14px;" type="text"
                                            ...
                                            value="{{ old('potongan_memo', $inquery->potongan_memo) }}">
                                        <input style="margin-left: 565px" class="form-check-input" type="checkbox"
                                            id="additional_checkbox" name="additional_checkbox" onchange="limitInput()">
                                    ...
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        <label style="font-size: 14px; margin-right: 42px;"
                                            for="rute_perjalanan">Administrasi</label>
                                        <input style="width: 300px; font-size: 14px;" id="uang_jaminan" type="text"
                                            class="form-control text-right" readonly name="uang_jaminan" placeholder=""
                                    ...
                                    <div class="form-group" style="display: flex; align-items: center;">
                                        ...
                                        <input style="width: 300px; font-size: 14px;" type="text"
                                            ...
                                            value="{{ old('deposit_drivers', $inquery->deposit_driver) }}">
                                        <label
                            ...
                            <td>
                                <div class="form-group" style="display: flex; align-items: center;">
                                    <label style="font-size: 14px; margin-right: 30px;" for="rute_perjalanan">Total
                                        Borong</label>
                                    <input style="width: 300px; font-size: 14px;" type="text"
                                        class="form-control text-right" id="totalborong" readonly name="total_borongs"
                                        placeholder="" value="{{ old('total_borongs', $inquery->total_borongs) }}">
                                ...
                                <div class="form-group" style="display: flex; align-items: center;">
                                    <label style="font-size: 14px; margin-right: 82px;"
                                        for="rute_perjalanan">PPH</label>
                                    <input style="width: 300px; font-size: 14px;" type="text"
                                        class="form-control text-right" id="pph2" readonly name="pphs" placeholder=""
                                        value="{{ old('pphs', $inquery->pphs) }}">
                                ...
                                <div class="form-group" style="display: flex; align-items: center;">
                                    <label style="font-size: 14px; margin-right: 20px;" for="rute_perjalanan">Uang
                                        Jaminan</label>
                                    <input style="width: 300px; font-size: 14px;" id="uangjaminanss" type="text"
                                        class="form-control text-right" readonly name="uang_jaminans" placeholder=""
                                ...
                                <div class="form-group" style="display: flex; align-items: center;">
                                    ...
                                    <label style="font-size: 14px; margin-right: 10px; margin-left:45px"
                                        for="rute_perjalanan">Deposit Sopir</label>
                                    <input style="width: 300px; font-size: 14px; margin-left:6px" type="text"
                                        class="form-control" id="depositsdriversst" readonly name="depositsdriversst"
                                        placeholder=""
                                ...
                                <div class="form-group" style="display: flex; align-items: center;">
                                    ...
                                    <input style="width: 300px; font-size: 14px;" type="text"
                                        ...
                                        onclick="calculateHasilsrute()">
                                    <label style="color:white; font-size: 14px; margin-right: 78px; margin-left: 585px"
                                        for="rute_perjalanan">.</label>
                                </div>
                            </td>
                        </tr>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <textarea style="font-size:14px" type="text" class="form-control" id="keterangan"
                                        name="keterangan"
            ...
            <td>
                <div class="form-group">
                    <input style="font-size:14px; font-weight:bold" readonly type="text" class="form-control"
                        id="sub_total" name="sub_total" value="{{ old('sub_total', $inquery->sub_total) }}"
                        onclick="SubTotalss()">
                </div>
            </td>
            </tr>
        ...
        <div class="card" id="form_biayatambahan">
            ...
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody id="tabel-memotambahan">
                        ...
                        <tr id="memotambah-{{ $loop->index }}">
                            ...
                            <td hidden>
                                <div class="form-group" hidden>
                                    <input type="text" class="form-control" name="detail_idstambahan[]"
                                        value="{{ $detail['id'] }}">
                                </div>
                            <td>
                                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input style="font-size:14px" type="number" class="form-control text-right" id="grand_total"
        ...
        if (selectedKategori === "Memo Tambahan") {
            ...
            $('#deposit_driver').on('input', function() {
                ...
                if (nominalValue === "") {
                    ...
                    $('#depositsdriversst').val(saldoMasukValue);
