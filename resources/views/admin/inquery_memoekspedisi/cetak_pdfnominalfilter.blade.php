...
<body style="margin: 0; padding: 0;">
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">No Kabin
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">Rute
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">Uang Jalan
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">Uang Tambahan
            </td>
            <td class="td" style="text-align: left; padding: 5px; font-weight:bold; font-size: 13px;">Deposit
            </td>
        ...
        @foreach ($memos as $item)
            <tr>
                ...
                <td class="td" style="text-align: left; padding: 5px; font-size: 13px;">
                    {{ substr($memoekspedisi->nama_driver, 0, 10) }} ..</td>
                <td class="td" style="text-align: left; padding: 5px; font-size: 13px;">
                    {{ $memoekspedisi->no_kabin }}</td>
                <td class="td" style="text-align: left; padding: 5px; font-size: 13px;">
