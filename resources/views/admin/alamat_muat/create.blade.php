                        ...
                        <div class="form-group" style="flex: 8;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="telp" name="telp"
                                    style="font-size:14px" placeholder="Masukan no telp" value="{{ old('telp') }}">
                            </div>
                            <div class="form-group">
                                <label style="font-size: 14px" for="alamat">Tujuan Muat</label>
                                <input type="text" class="form-control" id="alamat" name="alamat"
                                    style="font-size:14px" placeholder="masukkan tujuan muat" value="{{ old('alamat') }}">
                            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Data Lokasi EasyGo</h4>
