...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/alamat_muat/' . $alamatmuats->id) }}" method="POST" autocomplete="off">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Perbarui Tujuan Muat</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="form-group" style="flex: 8;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="telp" name="telp"
                                    placeholder="Masukan no telp" value="{{ old('telp', $alamatmuats->telp) }}">
                            </div>
                            <div class="form-group">
                                <label for="alamat">Tujuan Muat</label>
                                <input type="text" class="form-control" id="alamat" name="alamat"
                                    placeholder="masukkan tujuan muat" value="{{ old('alamat', $alamatmuats->alamat) }}">
                            </div>
                        </div>
