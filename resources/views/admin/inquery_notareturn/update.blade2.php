...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input class="form-control" hidden id="return_id" name="return_id" type="text" placeholder=""
                                value="{{ old('return_id', $inquery->return_id) }}" readonly
                                style="margin-right: 10px; font-size:14px" />
                            <input class="form-control" id="kode_return" name="kode_nota" type="text" placeholder=""
                                value="{{ old('kode_nota', $inquery->kode_nota) }}" readonly style="font-size:14px" />
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <tbody id="tabel-pembelian">
                                @foreach ($details as $detail)
                                    <tr id="pembelian-{{ $loop->index }}">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input style="font-size:14px" type="number" class="form-control harga"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input style="text-align: end; margin:right:10px; font-size:14px;" type="number"
    ...
    <script>
        ...
        function getSatuan(rowIndex) {
            ...
            $('#harga-' + activeSpecificationIndexs).val(nominal);
    ...
    <script>
        ...
        function itemPembelian(identifier, key, value = null) {
            ...
            item_pembelian += '<td>';
            item_pembelian += '<div class="form-group">'
            item_pembelian += '<input type="number" class="form-control harga" style="font-size:14px" id="harga-' + key +
                '" name="harga[]" value="' +
                harga +
                '" ';
            item_pembelian += '</div>';
            ...
            item_pembelian += '<td>';
            item_pembelian += '<div class="form-group">'
            item_pembelian += '<input type="number" class="form-control total" style="font-size:14px" id="total-' + key +
                '" name="total[]" value="' +
                total +
                '" ';
            item_pembelian += '</div>';
    ...
    <script>
        ...
        function Hitung(startingElement) {
            $(document).on("input", startingElement, function() {
                ...
                var hargasatuan = parseFloat(currentRow.find(".harga").val()) || 0;
                var diskon = parseFloat(currentRow.find(".diskon").val()) || 0;
                var harga = hargasatuan * jumlah - diskon;
                currentRow.find(".total").val(harga);
