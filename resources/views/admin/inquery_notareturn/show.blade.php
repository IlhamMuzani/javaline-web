...
<body style="margin: 0; padding: 0;">
    ...
    {{-- <table style="width: 100%;" cellpadding="2" cellspacing="0">
        <tr>
            <td colspan="4" style="text-align: right; padding-left: 78px; font-size: 17px;">Potongan
            </td>
            <td class="td" style="text-align: right; font-size: 17px;">
                0
            </td>
        ...
        <tr>
            <td colspan="4" style="text-align: right; padding: 0px; font-size: 17px;">Grand Total</td>
            <td class="td" style="text-align: right;  font-size: 17px;">
                {{ number_format($totalHarga, 0, ',', '.') }}
            </td>
        </tr>
...
<div class="container">
    ...
    <a href="{{ url('admin/inquery_notareturn') . '?status=&tanggal_awal=' . $cetakpdf->tanggal_awal . '&tanggal_akhir=' . $cetakpdf->tanggal_awal . '&ids=' }}"
        class="blue-button">
        Kembali
    </a>
    <a href="{{ url('admin/nota_returnbarang/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
