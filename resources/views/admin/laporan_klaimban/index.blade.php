...
@section('title', 'Laporan Klaim Ban')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Klaim Ban</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Klaim Ban</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Laporan Klaim Ban</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($inquery as $pemasangan_part)
                                <tr>
                                    ...
                                    <td>{{ $pemasangan_part->kode_klaimban }}</td>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/laporan_klaimban') }}";
            form.submit();
        }
        ...
        function printReport() {
            ...
            if (startDate && endDate) {
                form.action = "{{ url('admin/print_klaimban') }}" + "?start_date=" + startDate + "&end_date=" +
                    endDate;
                form.submit();
            } else {
