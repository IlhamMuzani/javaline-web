    ...
    <li class="nav-header">Menu</li>
    <li class="nav-item">
        <a href="{{ url('driver/pengambilan_do') }}" class="nav-link {{ request()->is('driver/pengambilan_do') ? 'active' : '' }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Pengambilan Do</p>
        </a>
        <a href="{{ url('driver/status_perjalanan') }}" class="nav-link {{ request()->is('driver/status_perjalanan') ? 'active' : '' }}">
            <i class="far fa-circle nav-icon"></i>
