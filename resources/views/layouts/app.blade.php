...
<body class="hold-transition sidebar-mini @if ( request()->is('admin/inquery_tagihanekspedisi*') ||request()->is('admin/tagihan_ekspedisi*') || request()->is('admin/faktur_ekspedisi*') || request()->is('admin/inquery_fakturekspedisi*') || request()->is('admin/inquery_memoekspedisi*') || request()->is('admin/inquery_memoborong*') || request()->is('admin/inquery_memotambahan*')|| request()->is('admin/laporan_memoekspedisi*')|| request()->is('admin/laporan_memoborong*')|| request()->is('admin/laporan_memotambahan*')) sidebar-open sidebar-collapse @endif">
    <div class="wrapper">
