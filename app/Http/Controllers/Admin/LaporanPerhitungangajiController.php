...
class LaporanPerhitungangajiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.laporan_perhitungangaji.index', compact('inquery'));
        // } else {
    ...
    public function print_perhitungangaji(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan penerimaan kas kecil']) {
        ...
        $query = Perhitungan_gajikaryawan::where('kategori', 'Mingguan');
        ...
        $pdf = PDF::loadView('admin.laporan_perhitungangaji.print', compact('inquery'));
