...
class PelunasanSewakendaraanfakturController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.pelunasan_sewakendaraan.createfaktur', compact('vendors', 'fakturs', 'invoices', 'returns', 'potonganlains'));
    }
