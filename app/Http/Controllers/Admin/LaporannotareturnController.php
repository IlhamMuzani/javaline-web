...
class LaporanNotareturnController extends Controller

{
    public function index(Request $request)
    {
        ...
        $inquery = Nota_return::orderBy('id', 'DESC');
        ...
        return view('admin.laporan_notareturn.index', compact('inquery'));
        // } else {
    ...
    public function print_nota(Request $request)
    {
        ...
        $query = Nota_return::orderBy('id', 'DESC');
        ...
        $pdf = PDF::loadView('admin.laporan_notareturn.print', compact('inquery'));
        return $pdf->stream('Laporan_Nota_return.pdf');
        // } else {
        //     // tidak memiliki akses
        //     return back()->with('error', array('Anda tidak memiliki akses'));
        // }
