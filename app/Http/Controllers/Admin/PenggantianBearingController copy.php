    ...
    public function store(Request $request)
    {
        ...
        if ($transaksi) {
            foreach ($data_pembelians as $data_pesanan) {
                ...
                if ($sparepart) {
                    // Kurangi jumlah sparepart sesuai dengan jumlah pesanan, ubah menjadi 0 jika jumlah null
                    $jumlah_pesanan = intval($data_pesanan['jumlah'] ?? 0);  // Jika null, default jadi 0
                    $jumlah_sparepart_sekarang = intval($sparepart->jumlah ?? 0);  // Jika null, default jadi 0
                    // Kurangi jumlah sparepart dengan jumlah pesanan
                    $jumlah_sparepart_baru = $jumlah_sparepart_sekarang - $jumlah_pesanan;

                    // Pastikan jumlah sparepart tidak negatif
                    $jumlah_sparepart_baru = max($jumlah_sparepart_baru, 0);

                    // Update jumlah sparepart
                    $sparepart->update(['jumlah' => $jumlah_sparepart_baru]);
                    ...
                    $detail_pemakaians_data = [
                        ...
                        'jumlah' => $jumlah_pesanan, // Gunakan jumlah yang sudah dipastikan tidak null
