...
class InqueryPenggantianoliController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.inquery_penggantianoli.update', compact('penggantianoli', 'spareparts', 'details'));
        } else {
            // tidak memiliki akses
            return back()->with('error', array('Anda tidak memiliki akses'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return view('admin.inquery_penggantianoli.show', compact('parts', 'pemasangan_part'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('admin/inquery_penggantianoli')->with('success', 'Berhasil menghapus Pemasangan');
    }
