...
class KaryawanteknisiController extends Controller
{
    public function index(Request $request)
    {
        if (auth()->check() && auth()->user()->menu['karyawan']) {
            ...
            ->where('departemen_id', 3); // Filter untuk departemen_id 1
            ...
            return view('admin.karyawanteknisi.index', compact('karyawans'));
        }
    ...
    public function create()
    {
        if (auth()->check() && auth()->user()->menu['karyawan']) {
            ...
            return view('admin/karyawanteknisi.create', compact('departemens'));
        } else {
    ...
    public function cetakpdf($id)
    {
        ...
        $html = view('admin/karyawanteknisi.cetak_pdf', compact('cetakpdf'));
    ...
    public function show($id)
    {
        if (auth()->check() && auth()->user()->menu['karyawan']) {
            ...
            return view('admin.karyawanteknisi.show', compact('karyawan'));
        } else {
            // tidak memiliki akses
    ...
    public function edit($id)
    {
        if (auth()->check() && auth()->user()->menu['karyawan']) {
            ...
            return view('admin/karyawanteknisi.update', compact('karyawan', 'departemens'));
        } else {
            // tidak memiliki akses
            return back()->with('error', array('Anda tidak memiliki akses'));
        }
