...
class LaporanDetailkaskecilController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.laporan_detailkaskecil.index', compact('inquery'));
    }
    ...
    public function print_pengeluarankaskecil(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.laporan_detailkaskecil.print', compact('inquery'));
