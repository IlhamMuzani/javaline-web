...
class LaporanPemasukanujsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $inquery = Uangjaminan::orderBy('id', 'DESC');
        ...
        return view('admin.laporan_pemasukanujs.index', compact('inquery'));
        // } else {
    ...
    public function print_pemasukanujs(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan penerimaan kas kecil']) {
        ...
        $query = Uangjaminan::orderBy('id', 'DESC');
        ...
        $pdf = PDF::loadView('admin.laporan_pemasukanujs.print', compact('inquery'));
        return $pdf->stream('Laporan_Pemasukan_UJS.pdf');
        // } else {
        //     // tidak memiliki akses
        //     return back()->with('error', array('Anda tidak memiliki akses'));
        // }
